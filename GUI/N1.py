    ...
    for x in projection_file_name_list:
        ...
        if l == 1:
            if x == 'FRAME1':
                ...
                number += 1
                part_view_number = str(number)
                N.Material_diagram_projection(p3, X3, Y3 , x, scale , part_view_number)
                number += 1
                part_view_number = str(number)
                ...
                number += 1
                part_view_number = str(number)
                N.Material_diagram_projection(p4, X4, Y4, x, scale , part_view_number)
                number += 1
                part_view_number = str(number)
                N.Material_diagram_projection(p5, X5, Y5, x, scale , part_view_number)
                number += 1
                part_view_number = str(number)
