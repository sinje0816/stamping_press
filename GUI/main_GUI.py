...
FRAME1_cutout = [655 + 370, 675 + 415, 695 + 450, 715 + 577.5, 735 + 670, 755 + 770, 775 + 895, 795 + 1080,
                 815 + 1210]
...
class main(QtWidgets.QWidget, Ui_Dialog):
    ...
    def ass_(self, h , i , l , j , k , path):
        ...
        # 離合器跟FRAME3組立
        mprog.add_offset_product_assembly('CRANK_SHAFT_All.1', 'Geometrical Set.2', 'FRAME20.1', -457.052, 'XY.PLANE',
                                          0)
