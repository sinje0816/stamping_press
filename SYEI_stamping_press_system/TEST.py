...
# # # # # # # #
# # # # # # # # # 圈碼圖生成
# # # # # # # # draft.balloons('Front view', '1', -par.A[i] / 2 - 100 * par.cos30, (par.H[i] - par.S[i] - par.Z[i]) * par.par.sin30 / 2, -par.A[i] / 2, (par.H[i] - par.S[i] - par.Z[i]) / 2, -par.A[i] / 2 - 100 * par.cos30)
# # # # # # # # drafting_down_Coordinate_Position, drafting_up_Coordinate_Position, scale = draft.drafting_welding_view_parameter_calculation(
...
# # # # # # # #     leakproof_broken_line = {
# # # # # # # #         'Front view': [[float(-par.A[i] / 2 + par.FRAME_6_7_width[i] + 50), float(0),
# # # # # # # #                         float(-par.A[i] / 2 + 50 + par.FRAME_6_7_width[i]), float(-par.S[i] / 2 - 200)], 1,
# # # # # # # #                        'Section view H-H']}
# # # # # # # #     draft.Section('Front view', drafting_down_Coordinate_Position['Section view A-A'][0],
# # # # # # # #                   drafting_down_Coordinate_Position['Section view A-A'][1], scale,
# # # # # # # #                   leakproof_broken_line['Front view'][0], leakproof_broken_line['Front view'][1],
...
# # # # # # # #                     float(-par.R[i] / 2 - 20), float(-par.S[i] / 2 - 200)], 1,
# # # # # # # #                    'Section view H-H']}
# # # # # # # # draft.Section('Front view', drafting_down_Coordinate_Position['Section view A-A'][0],
# # # # # # # #               drafting_down_Coordinate_Position['Section view A-A'][1], scale,
# # # # # # # #               leakproof_broken_line['Front view'][0], leakproof_broken_line['Front view'][1],
...
# # # # # # # #                                 float(par.FRAME_10_11_center_to_Y_2[i]), float(979),
# # # # # # # #                                 float(par.FRAME_10_11_center_to_Y_2[i]),
# # # # # # # #                                 float(979), float(par.FRAME_10_11_center_to_Y_1[i])]
# # # # # # # # draft.Define_Polygonal_Cipping_View('Section view H-H', Detail_view_leak_broken_line)
# # # # # # # # draft.selection_Search_delete('Front view', "Name='Callout (Section View).3', all")
# # # # # # # #
# # # # # # # # # 焊接符號生成
...
# # # # # #         par.A[i], par.B[i], par.H[i], par.T[i])  # 計算爆炸圖比例及位置
# # # # # # else:
# # # # # #     drafting_Coordinate_Position, drafting_isometric_Coordinate_Position, scale = draft.drafting_parameter_calculation(
...
# # # # # # par.sin30 = math.sin(math.radians(30))
...
# # # # # # BOLSTER1_XY = BOLSTER1_XY_T + par.DH_S[i]
# # # # # #
# # # # # # balloons_posotion = [750 * cos30, 750 * par.sin30]
# # # # # # CLOCK_Pointer = 3325
# # # # # # FRAME_TOP_LEFT_X = (par.R[i] + 90 + 50) * cos45 + 50
# # # # # # FRAME_TOP_LEFT_X_1 = FRAME_TOP_LEFT_X * par.sin30 / cos30
# # # # # #
# # # # # # scale = 1 / scale
# # # # # #
...
# # # # # mprog.add_offset_assembly('FRAME35.1', 'FRAME20.1', -(par.H[i] - par.Z[i] - par.S[i] - 34 + 448 + alpha), 'XY.PLANE', 0, 125)
...
# # # # #                                       1, 183)
# # # # # # 離合器與FRAME20結合
# # # # # mprog.add_offset_product_assembly('CLUCTH_ASSEMBLY_All.1', 'Geometrical Set.1', 'FRAME20.1', -(par.H[i] - par.Z[i] - par.S[i] - 34 + 448), 'XY.PLANE',
# # # # #                                       0, 184)
...
# # # #                         if name == 'FRAME10' or name == 'FRAME11':
# # # #                             mprog.param_change(name, 'alpha', alpha)
# # # #                         if name == 'BOLSTER1':
...
# # # #     # 後方大軸承
# # # #     mprog.add_offset_assembly('FRAME35.1', 'FRAME3.1', 0, 'XZ.PLANE', 1, 124)
# # # #     mprog.add_offset_assembly('FRAME35.1', 'FRAME20.1', -(par.H[i] - par.Z[i] - par.S[i] - 34 + 448 + alpha),
# # # #                               'XY.PLANE', 0, 125)
# # # #     mprog.add_offset_assembly('FRAME35.1', 'FRAME20.1', -par.FRAME20_FRAME2_YZ[i] - 36, 'YZ.PLANE', 0, 126)
# # # #     # 後方馬達下支撐板
# # # #     mprog.add_offset_assembly('FRAME39.1', 'FRAME1.1', 50, 'XZ.PLANE', 1, 127)
...
# # # #                                       -(par.H[i] - par.Z[i] - par.S[i] - 34 + 448), 'XY.PLANE',
# # # #                                       0, 184)
# # # #     mprog.add_offset_product_assembly('CLUCTH_ASSEMBLY_All.1', 'Geometrical Set.1', 'FRAME20.1', 0, 'XZ.PLANE', 1,
# # # #                                       185)
# # # #     mprog.add_offset_product_assembly('CLUCTH_ASSEMBLY_All.1', 'Geometrical Set.1', 'FRAME20.1', 512, 'YZ.PLANE', 1,
...
if l == 1:
    ...
    point_position = {'2': [-CLOCK_Offset_value * par.cos45,
                      ...
                      '5': [(-BOLSTER1_Offset_value - par.R_15[i]) * par.cos45,
                            (-BOLSTER1_Offset_value - par.R_15[i]) * par.cos45 * par.sin30 / par.cos30 - par.S[i] + par.T[i]],
