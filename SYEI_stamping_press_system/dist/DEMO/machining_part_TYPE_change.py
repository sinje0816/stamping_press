...
def change_machining_parameter(name, stamping_press_type, machiningdiepad, travel_type):
    ...
    # 判斷是否需要模墊加
        ...
        if stamping_press_type == 6:
            ...
            mprog.partbodyfeatureactivate('Body')
        mprog.Update()
    elif name == 'FRAME_WIRE_CASING':  # 已更改
        excel = epc.ExcelOp('尺寸整理表', 'FRAME_WIRE_CASING')
        parameter_name, parameter_value = excel.get_sheet_par('FRAME_WIRE_CASING', stamping_press_type)
        if stamping_press_type == 0 or stamping_press_type == 1or stamping_press_type == 2or stamping_press_type == 3or stamping_press_type == 4:
            mprog.activatefeature('Hole_3', 2)
        else:
            mprog.activatefeature('Hole_3', 0)
        mprog.Update()
