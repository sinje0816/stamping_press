...
class main(QtWidgets.QWidget, Ui_Form):
    ...
    def setting(self):
        ...
        combo_box_law.setEditable(True)
        combo_box_law.lineEdit().setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
        ...
        combo_box_machine.setEditable(True)  # 先將選單可編輯化
        combo_box_machine.lineEdit().setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)  # 接著設定置中
        ...
        combo_box_type.setEditable(True)
        combo_box_type.lineEdit().setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
        ...
        shockproof_company.setEditable(True)
        shockproof_company.lineEdit().setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
        ...
        power.lineEdit().setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
