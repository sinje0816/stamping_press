...
def assembly(stamping_press_type, apv, path, alpha, beta, zeta, epsilon, specifications_close_working_height_value,
             travel_type, GUM, INVERTER, power, slide):
    # excel匯入(匯入組立尺寸)
    ...
    for name in range(len(part_name)):
        for x in range(int(part_quantity[name])):
            if part_name[name] == 'PANEL' or part_name[name] == 'CON_ROD' or part_name[name] == 'CON_ROD_BASE' or \
                    part_name[name] == 'CON_ROD_CAP' \
                    or part_name[name] == 'INVERTERBRACKET' or part_name[name] == 'POINTER' or part_name[
                name] == 'COVER' or part_name[name] == 'PLUG' \
                    or part_name[name] == 'feeding_shaft_cover' or part_name[name] == 'OIL_LEVEL_GAUGE' or part_name[
                name] == 'slide_gib' \
                    or part_name[name] == 'ELECTRIC_BOX_PLATE' or part_name[name] == 'MOUNT_FILTER' or part_name[
                name] == 'CONTROL_PANEL' or part_name[name] == 'PANEL_BOX' \
                    or part_name[name] == 'PANEL_BOX_BRACKET' or part_name[name] == 'ELECTRIC_BOX' or part_name[
                name] == 'GUARD_FLYWHEEL' or part_name[name] == 'NAME_PLATE' \
                    or part_name[name] == 'TRADEMARK_NAMEPLATE' or part_name[name] == 'OPERATION_BOX' or part_name[
                name] == 'PORTABLE_STAND' or part_name[name] == 'OPERATION_BOX' \
                    or part_name[name] == 'BEARING_HOUSING' or part_name[name] == 'SLIDE' or part_name[
                name] == 'BALANCER' or part_name[name] == 'MOTOR_BRACKET' \
                    or part_name[name] == 'MOTOR' or part_name[name] == 'WIRE_CASING' or part_name[
                name] == 'ANTI_VIBRATION_GUM' or part_name[name] == 'HANDEL_MOUNT_FILTER' \
                    or part_name[name] == 'INVERTER':  # 固定零件匯入清單
                # 讀取其餘STP檔
                S_i.Assmebly(part_name[name], path + '\\' + 'machining', stamping_press_type, travel_type, GUM,
                             INVERTER, power, slide)
                continue
            else:
    ...
    mprog.add_offset_assembly('FRAME2.1', 'FRAME1.1',
                              -(apv['FRAME22']['D'] + (apv['FRAME1']['CC'] / 2) + (apv['FRAME2']['CC'] / 2)),
                              'ZX plane', 0, 6)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('FRAME3.1', 'FRAME1.1', -(apv['FRAME1']['A'] - apv['FRAME3']['A']) - 0.5 * alpha - beta,
                              'XY plane', 0, 43)
    mprog.add_offset_assembly('FRAME3.1', 'FRAME1.1', -(apv['FRAME1']['F'] - assmebly_par['Ass_F']) - zeta, 'YZ plane',
                              0, 44)
    mprog.add_offset_assembly('FRAME3.1', 'FRAME1.1', -(apv['FRAME1']['CC'] / 2 + apv['FRAME3']['B']), 'ZX plane', 0,
                              45)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('FRAME4.1', 'FRAME2.1', -(apv['FRAME2']['A'] - apv['FRAME4']['A']) - 0.5 * alpha - beta,
                              'XY plane', 0, 46)
    mprog.add_offset_assembly('FRAME4.1', 'FRAME2.1', -(apv['FRAME2']['F'] - assmebly_par['Ass_G']) - zeta, 'YZ plane',
                              0, 47)
    ...
    if stamping_press_type == 0 or stamping_press_type == 1 or stamping_press_type == 2 or stamping_press_type == 3:
        mprog.add_offset_assembly('FRAME7.1', 'FRAME2.1',
                                  -((apv['FRAME2']['E'] - apv['FRAME2']['DD']) - apv['FRAME7']['A'] - apv['FRAME7'][
                                      'Y']),
                                  'XY plane', 0, 25)
        mprog.update()
        mprog.Close_All()
    ...
    mprog.add_offset_assembly('FRAME7.1', 'FRAME2.1', -(apv['FRAME2']['B'] - assmebly_par['Ass_B']) - zeta, 'YZ plane',
                              0, 26)
    mprog.update()
    mprog.Close_All()
    if stamping_press_type == 0 or stamping_press_type == 1 or stamping_press_type == 2 or stamping_press_type == 3:
    ...
    mprog.add_offset_assembly('FRAME8.1', 'FRAME1.1',
                              -(apv['FRAME1']['B'] - assmebly_par['Ass_B'] - apv['FRAME8']['B']) - zeta, 'YZ plane', 0,
                              38)
    ...
    mprog.add_offset_assembly('FRAME13.1', 'FRAME2.1', -(
            ...
            apv['FRAME13']['k'] - apv['FRAME13']['j'] - assmebly_par['Ass_V'] - assmebly_par['Ass_S']) - beta,
                              'XY plane',
                              0, 121)
    mprog.add_offset_assembly('FRAME13.1', 'FRAME2.1',
                              apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'] + zeta,
                              'YZ plane', 1, 122)
    ...
    mprog.add_offset_assembly('FRAME14.1', 'FRAME2.1', -(
            apv['FRAME2']['A'] - apv['FRAME30']['A'] - assmebly_par['Ass_S'] - apv['FRAME14']['g3']) - beta, 'XY plane',
                              0,
                              109)
    mprog.add_offset_assembly('FRAME14.1', 'FRAME2.1',
                              apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME14']['B'] - apv['FRAME2'][
                                  'FF'] + zeta,
                              'YZ plane', 1, 110)
    ...
    mprog.add_offset_assembly('FRAME17.1', 'FRAME1.1', -(
            apv['FRAME1']['A'] - apv['FRAME30']['A'] - assmebly_par['Ass_S'] - apv['FRAME17']['g3']) - beta, 'XY plane',
                              0,
                              112)
    mprog.add_offset_assembly('FRAME17.1', 'FRAME1.1',
                              apv['FRAME1']['F'] - apv['FRAME1']['G'] - apv['FRAME17']['B'] - apv['FRAME1'][
                                  'FF'] + zeta,
                              'YZ plane', 1, 113)
    ...
    mprog.add_offset_assembly('FRAME18.1', 'FRAME1.1', -(
            apv['FRAME1']['A'] - apv['FRAME1']['bbbbb'] - assmebly_par['Ass_M'] - apv['FRAME18'][
        'F']) - 0.5 * alpha - beta, 'XY plane',
                              0, 76)
    mprog.add_offset_assembly('FRAME18.1', 'FRAME1.1', (assmebly_par['Ass_N']), 'YZ plane', 1,
                              77)
    mprog.add_offset_assembly('FRAME18.1', 'FRAME1.1', (apv['FRAME1']['CC'] / 2 + apv['FRAME18']['B']), 'ZX plane', 1,
                              78)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('FRAME19.1', 'FRAME1.1', -((apv['FRAME1']['E'] - apv['FRAME19']['D'])), 'XY plane', 0, 28)
    mprog.add_offset_assembly('FRAME19.1', 'FRAME1.1', -(apv['FRAME1']['B'] - assmebly_par['Ass_C'] + zeta), 'YZ plane',
                              0, 29)
    ...
    mprog.add_offset_assembly('FRAME19.2', 'FRAME2.1', -(apv['FRAME2']['B'] - assmebly_par['Ass_C'] + zeta), 'YZ plane',
                              0, 32)
    mprog.add_offset_assembly('FRAME19.2', 'FRAME2.1', apv['FRAME2']['CC'] / 2, 'ZX plane', 0, 33)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('FRAME20.1', 'FRAME2.1', -(
            apv['FRAME1']['A'] - apv['FRAME1']['bbbbb'] - assmebly_par['Ass_R'] - apv['FRAME20'][
        'H']) - 0.5 * alpha - beta, 'XY plane',
                              0, 100)
    ...
    if stamping_press_type == 0 or stamping_press_type == 1 or stamping_press_type == 2:
        ...
        mprog.add_offset_assembly('FRAME22.1', 'FRAME35.2', -(apv['FRAME35']['B'] - apv['FRAME22']['O']), 'YZ plane', 1,
                                  17)
        mprog.update()
        mprog.Close_All()
    if stamping_press_type == 0 or stamping_press_type == 1 or stamping_press_type == 2 or stamping_press_type == 3:
        mprog.add_offset_assembly('FRAME22.1', 'FRAME1.1', -(apv['FRAME22']['D'] + apv['FRAME1']['CC'] / 2), 'ZX plane',
                                  0,
                                  18)
        mprog.update()
        mprog.Close_All()
    ...
    mprog.add_offset_assembly('FRAME24_1.1', 'FRAME30.1', apv['FRAME24']['A'] + apv['FRAME30']['M'] / 2, 'YZ plane', 0,
                              62)
    mprog.add_offset_assembly('FRAME24_1.1', 'FRAME30.1',
                              (apv['FRAME30']['E'] - (apv['FRAME24']['I'] - apv['FRAME2']['CC'])), 'ZX plane', 0,
                              63)
    mprog.update()
    mprog.Close_All()
    ...
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('FRAME30.1', 'FRAME2.1', -(apv['FRAME2']['A'] - apv['FRAME30']['A']) - beta, 'XY plane',
                              0, 40)
    mprog.add_offset_assembly('FRAME30.1', 'FRAME2.1', -(apv['FRAME2']['F'] - (apv['FRAME30']['M'] / 2)) - zeta,
                              'YZ plane', 0,
                              41)
    ...
    if stamping_press_type == 0 or stamping_press_type == 1 or stamping_press_type == 2:
        ...
        mprog.add_offset_assembly('FRAME35.2', 'FRAME2.1', (apv['FRAME2']['B'] - apv['FRAME35']['B']) + zeta,
                                  'YZ plane', 1, 8)
    ...
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.CON_ROD_CAP_list[stamping_press_type] + '.1', 'crankshaft.1',
                              apv['crankshaft']['Bx2'] + alpha / 2, 'XY plane', 0, 227)
    mprog.add_offset_assembly(S_i.CON_ROD_CAP_list[stamping_press_type] + '.1', 'crankshaft.1', (
                apv['crankshaft']['Ah1'] + apv['crankshaft']['Ah2'] + apv['crankshaft']['Bh1'] + apv['crankshaft'][
            'Bh2'] / 2), 'YZ plane', 0, 228)
    mprog.add_offset_assembly(S_i.CON_ROD_CAP_list[stamping_press_type] + '.1', 'crankshaft.1', 0, 'ZX plane', 0, 229)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.PANEL_list[stamping_press_type] + '.1',
                              S_i.BEARING_HOUSING_list[stamping_press_type] + '.1', 0, 'XY plane', 1, 236)
    mprog.add_offset_assembly(S_i.PANEL_list[stamping_press_type] + '.1',
                              S_i.BEARING_HOUSING_list[stamping_press_type] + '.1', -S_assmebly_par['PANEL_YZ'],
                              'YZ plane', 0, 237)
    mprog.add_offset_assembly(S_i.PANEL_list[stamping_press_type] + '.1',
                              S_i.BEARING_HOUSING_list[stamping_press_type] + '.1', 0, 'ZX plane', 0, 238)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.POINTER_list[stamping_press_type] + '.1', S_i.PANEL_list[stamping_press_type] + '.1',
                              0, 'XY plane', 1, 239)
    mprog.add_offset_assembly(S_i.POINTER_list[stamping_press_type] + '.1', S_i.PANEL_list[stamping_press_type] + '.1',
                              -10, 'YZ plane', 0, 240)
    mprog.add_offset_assembly(S_i.POINTER_list[stamping_press_type] + '.1', S_i.PANEL_list[stamping_press_type] + '.1',
    ...
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.slide_gib_list_left[stamping_press_type] + '.1', 'FRAME1.1',
                              -(apv['FRAME1']['E'] + apv['FRAME1']['D'] + beta), 'XY plane', 0, 248)
    mprog.add_offset_assembly(S_i.slide_gib_list_left[stamping_press_type] + '.1', 'FRAME1.1',
                              (apv['FRAME1']['F'] - apv['FRAME1']['G'] + S_assmebly_par['SGL_YZ']) + zeta, 'YZ plane',
                              1, 249)
    mprog.add_offset_assembly(S_i.slide_gib_list_left[stamping_press_type] + '.1', 'FRAME1.1',
                              -(S_assmebly_par['SGL_ZX'] - apv['FRAME1']['CC'] / 2), 'ZX plane', 0, 250)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.slide_gib_list_right[stamping_press_type] + '.1',
                              S_i.slide_gib_list_left[stamping_press_type] + '.1', 0, 'XY plane', 0, 251)
    mprog.add_offset_assembly(S_i.slide_gib_list_right[stamping_press_type] + '.1',
                              S_i.slide_gib_list_left[stamping_press_type] + '.1', 0, 'YZ plane', 0, 252)
    mprog.add_offset_assembly(S_i.slide_gib_list_right[stamping_press_type] + '.1',
                              S_i.slide_gib_list_left[stamping_press_type] + '.1', -(S_assmebly_par['SGR_ZX']),
                              'ZX plane', 0, 253)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('OGASKL060_OIL_LEVEL_GAUGE.1', 'FRAME1.1',
                              (apv['FRAME1']['A'] - apv['FRAME1']['a1']) + S_assmebly_par[
                                  'OLG_F_XY'] + 0.5 * alpha + beta, 'XY plane', 1, 254)
    mprog.add_offset_assembly('OGASKL060_OIL_LEVEL_GAUGE.1', 'FRAME1.1', -(
                (apv['FRAME1']['F'] - apv['FRAME1']['G'] - apv['FRAME1']['b']) - S_assmebly_par['OLG_F_YZ']) - zeta,
                              'YZ plane', 0, 255)
    mprog.add_offset_assembly('OGASKL060_OIL_LEVEL_GAUGE.1', 'FRAME1.1',
                              -(apv['FRAME1']['CC'] / 2 + S_assmebly_par['OLG_F_ZX']), 'ZX plane', 1, 256)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('EWR60S01_ELECTRIC_BOX_PLATE.1', 'FRAME2.1',
                              -(apv['FRAME2']['w4'] - apv['FRAME2']['kk1'] - S_assmebly_par['EBP_XY']), 'XY plane', 0,
                              260)
    mprog.add_offset_assembly('EWR60S01_ELECTRIC_BOX_PLATE.1', 'FRAME2.1', -(
                apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['jj'] + apv['FRAME2']['ll1'] - S_assmebly_par[
            'EBP_YZ']) - zeta, 'YZ plane', 0, 261)
    mprog.add_offset_assembly('EWR60S01_ELECTRIC_BOX_PLATE.1', 'FRAME2.1', -(apv['FRAME2']['CC'] / 2), 'ZX plane', 0,
                              262)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('EWR60S01_ELECTRIC_BOX_PLATE.2', 'EWR60S01_ELECTRIC_BOX_PLATE.1', 0, 'XY plane', 0, 263)
    mprog.add_offset_assembly('EWR60S01_ELECTRIC_BOX_PLATE.2', 'EWR60S01_ELECTRIC_BOX_PLATE.1',
                              (apv['FRAME2']['ll1'] + apv['FRAME2']['ll2']), 'YZ plane', 0, 264)
    ...
    mprog.add_offset_assembly(S_i.ELECTRIC_BOX_list_normal[stamping_press_type] + '.1', 'EWR60S01_ELECTRIC_BOX_PLATE.1',
                              -(S_assmebly_par['EB_XY']), 'XY plane', 0, 266)
    mprog.add_offset_assembly(S_i.ELECTRIC_BOX_list_normal[stamping_press_type] + '.1', 'EWR60S01_ELECTRIC_BOX_PLATE.1',
                              -(S_assmebly_par['EBP_YZ'] + S_assmebly_par['EB_YZ']), 'YZ plane', 0, 267)
    mprog.add_offset_assembly(S_i.ELECTRIC_BOX_list_normal[stamping_press_type] + '.1', 'EWR60S01_ELECTRIC_BOX_PLATE.1',
                              -5, 'ZX plane', 0, 268)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('EGPSSGD1000IS_MOUNT_FILTER.1', 'FRAME1.1', (apv['FRAME1']['e4'] + apv['FRAME1']['e3']),
                              'XY plane', 1, 278)
    mprog.add_offset_assembly('EGPSSGD1000IS_MOUNT_FILTER.1', 'FRAME1.1',
                              -(apv['FRAME1']['g'] - (apv['FRAME1']['d'] - apv['FRAME1']['i'])) - zeta, 'YZ plane', 0,
                              279)
    mprog.add_offset_assembly('EGPSSGD1000IS_MOUNT_FILTER.1', 'FRAME1.1', -(apv['FRAME1']['CC'] / 2), 'ZX plane', 1,
                              280)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.TRADEMARK_NAMEPLATE_list_normal[stamping_press_type] + '.1', 'FRAME1.1',
                              -(apv['FRAME1']['A'] - S_assmebly_par['TN_XY']) - 0.5 * alpha - beta, 'XY plane', 0, 281)
    mprog.add_offset_assembly(S_i.TRADEMARK_NAMEPLATE_list_normal[stamping_press_type] + '.1', 'FRAME1.1',
                              -(apv['FRAME1']['F'] - S_assmebly_par['TN_YZ']) - zeta, 'YZ plane', 0, 282)
    mprog.add_offset_assembly(S_i.TRADEMARK_NAMEPLATE_list_normal[stamping_press_type] + '.1', 'FRAME1.1',
                              -(apv['FRAME1']['CC'] / 2), 'ZX plane', 1, 283)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.TRADEMARK_NAMEPLATE_list_normal[stamping_press_type] + '.2', 'FRAME2.1',
                              -(apv['FRAME1']['A'] - S_assmebly_par['TN_XY']) - 0.5 * alpha - beta, 'XY plane', 0, 284)
    mprog.add_offset_assembly(S_i.TRADEMARK_NAMEPLATE_list_normal[stamping_press_type] + '.2', 'FRAME2.1',
                              (apv['FRAME1']['F'] - S_assmebly_par['TN_YZ'] + S_assmebly_par['TN_2_YZ']) - zeta,
                              'YZ plane', 1, 285)
    mprog.add_offset_assembly(S_i.TRADEMARK_NAMEPLATE_list_normal[stamping_press_type] + '.2', 'FRAME2.1',
                              -(apv['FRAME1']['CC'] / 2), 'ZX plane', 0, 286)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.NAME_PLATE_list_normal[stamping_press_type] + '.1', 'FRAME30.1',
                              -(apv['FRAME30']['A'] - S_assmebly_par['NP_XY']) - epsilon, 'XY plane', 0, 287)
    mprog.add_offset_assembly(S_i.NAME_PLATE_list_normal[stamping_press_type] + '.1', 'FRAME30.1',
                              -(apv['FRAME30']['M'] + S_assmebly_par['NP_YZ']), 'YZ plane', 0, 288)
    mprog.add_offset_assembly(S_i.NAME_PLATE_list_normal[stamping_press_type] + '.1', 'FRAME30.1',
                              -(apv['FRAME30']['E'] - S_assmebly_par['NP_ZX']), 'ZX plane', 1, 289)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.GUARD_FLYWHEEL_list_normal[stamping_press_type] + '.1', 'FRAME1.1',
                              (S_assmebly_par['GF_XY']) + 0.5 * alpha + beta, 'XY plane', 1, 290)
    mprog.add_offset_assembly(S_i.GUARD_FLYWHEEL_list_normal[stamping_press_type] + '.1', 'FRAME1.1', 6, 'YZ plane', 0,
                              291)
    mprog.add_offset_assembly(S_i.GUARD_FLYWHEEL_list_normal[stamping_press_type] + '.1', 'FRAME1.1',
                              (S_assmebly_par['GF_ZX']), 'ZX plane', 1, 292)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.PORTABLE_STAND_list[stamping_press_type] + '.1', 'FRAME22.1',
                              (apv['FRAME22']['A(1)'] - apv['FRAME22']['a'] + S_assmebly_par['PS_XY']), 'XY plane', 1,
                              296)
    mprog.add_offset_assembly(S_i.PORTABLE_STAND_list[stamping_press_type] + '.1', 'FRAME22.1', -apv['FRAME22']['O'],
                              'YZ plane', 0, 297)
    mprog.add_offset_assembly(S_i.PORTABLE_STAND_list[stamping_press_type] + '.1', 'FRAME22.1',
                              -(apv['FRAME22']['D'] - apv['FRAME22']['c'] + S_assmebly_par['PS_ZX']), 'ZX plane', 1,
                              298)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.OPERATION_BOX_list_normal[stamping_press_type] + '.1',
                              S_i.PORTABLE_STAND_list[stamping_press_type] + '.1',
                              0, 'XY plane', 0, 299)
    mprog.add_offset_assembly(S_i.OPERATION_BOX_list_normal[stamping_press_type] + '.1',
                              S_i.PORTABLE_STAND_list[stamping_press_type] + '.1', -S_assmebly_par['OB_YZ'],
                              'YZ plane', 0, 300)
    mprog.add_offset_assembly(S_i.OPERATION_BOX_list_normal[stamping_press_type] + '.1',
                              S_i.PORTABLE_STAND_list[stamping_press_type] + '.1',
    ...
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.BEARING_HOUSING_list[stamping_press_type] + '.1', 'FRAME30.1', -apv['FRAME30']['h'],
                              'XY plane', 0, 302)
    mprog.add_offset_assembly(S_i.BEARING_HOUSING_list[stamping_press_type] + '.1', 'FRAME30.1',
                              -(S_assmebly_par['BH_YZ']), 'YZ plane', 0, 303)
    mprog.add_offset_assembly(S_i.BEARING_HOUSING_list[stamping_press_type] + '.1', 'FRAME30.1',
                              apv['FRAME30']['E'] / 2, 'ZX plane', 0, 304)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('slide.1', 'plate.1',
                              -(specifications_close_working_height_value + beta + assmebly_par['Ass_AM']), 'XY plane',
                              0, 308)
    ...
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.BALANCER_list[stamping_press_type] + '.1', 'FRAME1.1', -(
                apv['FRAME1']['A'] - apv['FRAME1']['bbbbb'] + S_assmebly_par['B_XY'] + 0.5 * alpha + beta), 'XY plane',
                              0, 311)
    mprog.add_offset_assembly(S_i.BALANCER_list[stamping_press_type] + '.1', 'FRAME1.1', -(
                apv['FRAME1']['F'] - apv['FRAME1']['fffff1'] + apv['FRAME1']['ddddd1'] + zeta - S_assmebly_par['B_YZ']),
                              'YZ plane', 0, 312)
    mprog.add_offset_assembly(S_i.BALANCER_list[stamping_press_type] + '.1', 'FRAME1.1', -S_assmebly_par['B_ZX'],
                              'ZX plane', 0, 313)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.BALANCER_list[stamping_press_type] + '.2',
                              S_i.BALANCER_list[stamping_press_type] + '.1', 0, 'XY plane', 0, 314)
    mprog.add_offset_assembly(S_i.BALANCER_list[stamping_press_type] + '.2',
                              S_i.BALANCER_list[stamping_press_type] + '.1', 0, 'YZ plane', 0, 315)
    mprog.add_offset_assembly(S_i.BALANCER_list[stamping_press_type] + '.2',
                              S_i.BALANCER_list[stamping_press_type] + '.1', -S_assmebly_par['B2_ZX'], 'ZX plane', 0,
                              316)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_SLIDE[stamping_press_type] + '.1', 'slide.1',
                              -S_assmebly_par['OLS_XY'], 'XY plane', 0, 317)
    mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_SLIDE[stamping_press_type] + '.1', 'slide.1',
                              -S_assmebly_par['OLS_YZ'], 'YZ plane', 0, 318)
    mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_SLIDE[stamping_press_type] + '.1', 'slide.1',
                              -S_assmebly_par['OLS_ZX'], 'ZX plane', 0, 319)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_SLIDE[stamping_press_type] + '.2', 'slide.1',
                              -S_assmebly_par['OLS2_XY'], 'XY plane', 0, 320)
    mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_SLIDE[stamping_press_type] + '.2', 'slide.1',
                              -S_assmebly_par['OLS2_YZ'], 'YZ plane', 0, 321)
    mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_SLIDE[stamping_press_type] + '.2', 'slide.1',
                              -S_assmebly_par['OLS2_ZX'], 'ZX plane', 0, 322)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('MZW8702_WIRE_CASING.1', S_i.ELECTRIC_BOX_list_normal[stamping_press_type] + '.1',
                              S_assmebly_par['EW_XY'], 'XY plane', 0, 329)
    mprog.add_offset_assembly('MZW8702_WIRE_CASING.1', S_i.ELECTRIC_BOX_list_normal[stamping_press_type] + '.1',
                              S_assmebly_par['EW_YZ'], 'YZ plane', 0, 330)
    mprog.add_offset_assembly('MZW8702_WIRE_CASING.1', S_i.ELECTRIC_BOX_list_normal[stamping_press_type] + '.1', 0,
                              'ZX plane', 1, 331)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('43N6603_WIRE_CASING.1', 'FRAME2.1', -(
                apv['FRAME2']['w4'] - apv['FRAME2']['l2'] - apv['FRAME2']['l3'] - apv['FRAME2']['l4'] - apv['FRAME2'][
            'l5'] / 2), 'XY plane', 0, 332)
    mprog.add_offset_assembly('43N6603_WIRE_CASING.1', 'FRAME2.1', -(apv['FRAME2']['k'] - 15 + zeta), 'YZ plane', 0,
                              333)
    mprog.add_offset_assembly('43N6603_WIRE_CASING.1', 'FRAME2.1', -(apv['FRAME2']['CC'] / 2 + S_assmebly_par['EF_ZX']),
                              'ZX plane', 1, 334)
    mprog.update()
    mprog.Close_All()
    ...
    mprog.add_offset_assembly('43N6604_WIRE_CASING.1', '43N6603_WIRE_CASING.1', -(S_assmebly_par['EE_ZX']), 'ZX plane',
                              0, 337)
    mprog.update()
    mprog.Close_All()
    mprog.add_offset_assembly('FRAME_WIRE_CASING.1', 'FRAME2.1', -(apv['FRAME2']['w4'] - apv['FRAME_WIRE_CASING']['B']),
                              'XY plane', 0, 338)
    mprog.add_offset_assembly('FRAME_WIRE_CASING.1', 'FRAME2.1',
                              -(apv['FRAME2']['k'] - apv['FRAME_WIRE_CASING']['E'] / 2 + zeta), 'YZ plane', 0, 339)
    mprog.add_offset_assembly('FRAME_WIRE_CASING.1', 'FRAME2.1', -(apv['FRAME2']['CC'] / 2), 'ZX plane', 1, 340)
    mprog.update()
    mprog.Close_All()
    # 選配零件(用try防止沒有選配到該零件的時候跳錯)
    try:
        mprog.add_offset_assembly('plate.1', 'FRAME22.1', -(apv['FRAME22']['A(1)'] - apv['FRAME22']['A(2)']),
                                  'XY plane', 0, 305)
        mprog.add_offset_assembly('plate.1', 'FRAME22.1',
                                  (par.plate_length_width[1] / 2 - assmebly_par['Ass_AL'] + apv['FRAME22']['O']),
                                  'YZ plane', 1, 306)
        mprog.add_offset_assembly('plate.1', 'FRAME22.1', -(par.plate_length_width[0] / 2 - apv['FRAME22']['D'] / 2),
                                  'ZX plane', 0, 307)
        mprog.update()
        mprog.Close_All()
        if GUM == '穎益':
    ...
    if stamping_press_type == 0:
        ...
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1',
                                  -(apv['FRAME4']['A'] - apv['FRAME4']['a'] - apv['FRAME4']['b'] / 2), 'XY plane', 0,
                                  49)
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1', -(apv['FRAME4']['C'] - assmebly_par['Ass_H']), 'YZ plane', 0,
                                  50)
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1', apv['FRAME4']['B'] / 2 - apv['FRAME4']['b'] / 2, 'ZX plane',
                                  0, 51)
        ...
        mprog.add_offset_assembly('FRAME36.1', 'FRAME4.1', -(
                    (assmebly_par['Ass_J'] - apv['FRAME36']['A'] / 2) + (apv['FRAME4']['A'] - apv['FRAME4']['a'])),
                                  'XY plane', 0, 67)
        mprog.add_offset_assembly('FRAME36.1', 'FRAME4.1',
                                  -(apv['FRAME4']['K'] + (apv['FRAME25']['A'] - apv['FRAME36']['C'])), 'YZ plane', 0,
                                  68)
        ...
        mprog.add_offset_assembly('FRAME6.2', 'FRAME4.1', apv['FRAME4']['B'] / 2 + apv['FRAME6']['f'], 'ZX plane', 0,
                                  93)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1', apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                    apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + beta, 'XY plane', 1, 127)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1', -(
                    apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'] - assmebly_par['Ass_T'] -
                    apv['FRAME21']['D']) - zeta, 'YZ plane', 0, 128)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1', -(
                    apv['FRAME3']['B'] / 2 - assmebly_par['Ass_U'] + apv['FRAME1']['CC'] / 2 - apv['FRAME21']['C']),
                                  'ZX plane', 0, 129)
        mprog.add_offset_assembly('FRAME21.2', 'FRAME2.1', apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                    apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + beta, 'XY plane', 1, 130)
        mprog.add_offset_assembly('FRAME21.2', 'FRAME2.1', -(
                    apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'] - assmebly_par['Ass_T'] -
                    apv['FRAME21']['D']) - zeta, 'YZ plane', 0, 131)
        mprog.add_offset_assembly('FRAME21.2', 'FRAME2.1',
    ...
    # 35頓
        ...
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', apv['FRAME2']['CC'] / 2, 'ZX plane', 0, 24)
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1',
                                  (apv['FRAME4']['A'] - apv['FRAME4']['a'] + apv['FRAME31']['F'] / 2), 'XY plane', 1,
                                  49)
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1', -assmebly_par['Ass_H'], 'YZ plane', 1, 50)
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1', apv['FRAME4']['B'] / 2 - apv['FRAME31']['F'] / 2, 'ZX plane',
                                  0, 51)
        mprog.add_offset_assembly('FRAME11.1', 'FRAME3.1',
                                  -(apv['FRAME3']['A'] - apv['FRAME3']['E'] - apv['FRAME11']['A'] / 2), 'XY plane', 0,
                                  64)
        ...
        mprog.add_offset_assembly('FRAME11.1', 'FRAME3.1', apv['FRAME3']['B'] / 2 + apv['FRAME11']['A'] / 2, 'ZX plane',
                                  0, 66)
        mprog.add_offset_assembly('FRAME36.1', 'FRAME4.1', -(
                    (assmebly_par['Ass_J'] - apv['FRAME36']['F'] / 2) + (apv['FRAME4']['A'] - apv['FRAME4']['a'])),
                                  'XY plane', 0, 67)
        ...
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1', apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                    apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + beta, 'XY plane', 1, 127)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1', -(
                    apv['FRAME2']['F'] - apv['FRAME2']['G'] - assmebly_par['Ass_T'] - apv['FRAME21']['D']) - zeta,
                                  'YZ plane', 0, 128)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1', -(
                    apv['FRAME3']['B'] / 2 - assmebly_par['Ass_U'] + apv['FRAME1']['CC'] / 2 - apv['FRAME21']['C']),
                                  'ZX plane', 0, 129)
    ...
    # 45頓
        ...
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1',
                                  ...
                                  49)
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1',
                                  -(apv['FRAME4']['K'] + apv['FRAME31']['C'] - assmebly_par['Ass_H']), 'YZ plane', 0,
                                  50)
        mprog.add_offset_assembly('FRAME31.1', 'FRAME4.1', -(apv['FRAME4']['B'] / 2 + apv['FRAME31']['F'] / 2),
                                  'ZX plane', 1, 51)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', 0, 'XY plane', 0, 19)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', -(apv['FRAME1']['B'] - apv['FRAME33']['B']) - zeta,
                                  'YZ plane', 0, 20)
    ...
    # 60頓待修
        ...
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1',
                                  ...
                                  99)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', 0, 'XY plane', 0, 19)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', -(
                    apv['FRAME1']['B'] - apv['FRAME33']['B'] - apv['FRAME33']['M'] - apv['FRAME33']['O']) - zeta,
                                  'YZ plane', 0, 20)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', -(apv['FRAME33']['K'] + apv['FRAME1']['CC'] / 2), 'ZX plane',
                                  0, 21)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', 0, 'XY plane', 0, 22)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', -(
                    apv['FRAME2']['B'] - apv['FRAME34']['B'] - apv['FRAME34']['Q'] - apv['FRAME34']['S']) - zeta,
                                  'YZ plane', 0, 23)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', apv['FRAME2']['CC'] / 2, 'ZX plane', 0, 24)
        mprog.add_offset_assembly('FRAME36.1', 'FRAME4.1', -(
                (assmebly_par['Ass_J'] - apv['FRAME36']['A'] / 2) + (apv['FRAME4']['A'] - apv['FRAME4']['a'])),
    ...
    # 110頓
        ...
        mprog.add_offset_assembly('FRAME6.1', 'FRAME4.1',
                                  assmebly_par['Ass_Q'] - (
                                              apv['FRAME4']['A'] - apv['FRAME4']['a'] + apv['FRAME6']['E'] / 2) +
                                  apv['FRAME6']['E'], 'XY plane', 0, 88)
        ...
        mprog.add_offset_assembly('FRAME29.1', 'FRAME4.1', -(
                assmebly_par['Ass_Q'] + (apv['FRAME4']['A'] - apv['FRAME4']['a']) - apv['FRAME29']['A'] / 2),
                                  'XY plane', 0, 94)
        mprog.add_offset_assembly('FRAME29.1', 'FRAME4.1', (apv['FRAME29']['B'] - apv['FRAME29']['F']), 'YZ plane', 1,
                                  95)
        mprog.add_offset_assembly('FRAME29.1', 'FRAME4.1',
                                  -(apv['FRAME4']['B'] / 2 - apv['FRAME6']['e'] - apv['FRAME29']['A'] / 2), 'ZX plane',
                                  1,
                                  96)
        mprog.update()
        mprog.Close_All()
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1', -(
                assmebly_par['Ass_Q'] + (apv['FRAME4']['A'] - apv['FRAME4']['a']) - apv['FRAME29']['A'] / 2),
                                  'XY plane', 0, 97)
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1', (apv['FRAME29']['B'] - apv['FRAME29']['F']), 'YZ plane', 1,
                                  98)
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1',
                                  -(apv['FRAME4']['B'] / 2 + apv['FRAME6']['e'] - apv['FRAME29']['A'] / 2), 'ZX plane',
                                  1,
        ...
        mprog.add_offset_assembly('FRAME50.1', 'FRAME4.1',
                                  -(apv["FRAME4"]["k"] + assmebly_par['Ass_AC'] - apv["FRAME50"]["B"] / 2), 'XY plane',
                                  0, 173)
        ...
        mprog.update()
        mprog.Close_All()
        mprog.add_offset_assembly('FRAME49.1', 'FRAME4.1', -(apv["FRAME4"]["k"] + assmebly_par['Ass_AE']), 'XY plane',
                                  0, 176)
        ...
        mprog.add_offset_assembly('FRAME48.2', 'FRAME8.1', (assmebly_par['Ass_AF'] + apv["FRAME48"]["C"]), 'YZ plane',
                                  1, 183)
        mprog.add_offset_assembly('FRAME48.2', 'FRAME8.1', 0, 'ZX plane', 1, 184)
        mprog.update()
        mprog.Close_All()
        mprog.add_offset_assembly('FRAME23_1.1', 'FRAME22.1',
                                  -(apv["FRAME22"]["A(1)"] - apv["FRAME22"]["A(2)"] - apv["FRAME23"]["I"]), 'XY plane',
                                  0, 185)
        ...
        mprog.add_offset_assembly('FRAME47.1', 'FRAME22.1',
                                  -(apv["FRAME22"]["A(1)"] - apv["FRAME22"]["A(2)"] - apv["FRAME47"]["E"]), 'XY plane',
                                  0, 188)
        ...
        mprog.add_offset_assembly('FRAME43.2', 'FRAME13_1.1',
                                  apv["FRAME13"]["I"] + (apv["FRAME13"]["E"] - apv["FRAME13"]["I"]), 'ZX plane', 1, 202)
        mprog.update()
        mprog.Close_All()
        ...
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1',
                                  -(apv['crankshaft']['Bx2'] + alpha / 2), 'XY plane', 1, 230)
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1', (
                    apv['crankshaft']['Ah1'] + apv['crankshaft']['Ah2'] + apv['crankshaft']['Bh1'] + apv['crankshaft'][
                'Bh2'] / 2), 'YZ plane', 0, 231)
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1', 0, 'ZX plane', 0,
                                  232)
        mprog.update()
        mprog.Close_All()
        mprog.add_offset_assembly(S_i.CON_ROD_list[stamping_press_type] + '.1',
                                  S_i.CON_ROD_CAP_list[stamping_press_type] + '.1',
                                  (S_assmebly_par['C_R_XY'] - alpha / 2), 'XY plane', 0, 233)
        mprog.add_offset_assembly(S_i.CON_ROD_list[stamping_press_type] + '.1',
        ...
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type] + '.1', 'FRAME1.1', -(
                    apv['FRAME1']['F'] - (apv['FRAME1']['fffff1'] + apv['FRAME1']['fffff2']) + S_assmebly_par[
                'C_YZ'] + zeta), 'YZ plane', 0, 243)
        ...
        if travel_type == 1:
            ...
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      S_assmebly_par['MB_XY'], 'XY plane', 1, 323)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      S_assmebly_par['MB_YZ'], 'YZ plane', 0, 324)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      -S_assmebly_par['MB_ZX'], 'ZX plane', 0, 325)
            ...
            mprog.Close_All()
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', S_assmebly_par['M_XY'],
                                      'XY plane', 0, 326)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', -S_assmebly_par['M_YZ'],
                                      'YZ plane', 0, 327)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', S_assmebly_par['M_ZX'],
                                      'ZX plane', 0, 328)
            mprog.update()
            mprog.Close_All()
        # 變頻器選配
    ...
    # 250頓
        ...
        mprog.add_offset_assembly('FRAME51.1', 'FRAME1.1', -(apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                                             assmebly_par['Ass_V'] - assmebly_par['Ass_S'] +
                                                             apv['FRAME15']['A'] - apv['FRAME51']['A'] + beta),
                                  'XY plane', 0, 127)
        ...
        mprog.add_offset_assembly('FRAME29.1', 'FRAME4.1', (apv['FRAME29']['B'] - apv['FRAME29']['F']), 'YZ plane', 1,
                                  95)
        mprog.add_offset_assembly('FRAME29.1', 'FRAME4.1',
                                  -(apv['FRAME4']['B'] / 2 - apv['FRAME29']['A'] / 2 + assmebly_par['Ass_Q']),
                                  'ZX plane', 1,
                                  96)
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1', -(
                assmebly_par['Ass_Q'] + (apv['FRAME4']['A'] - apv['FRAME4']['a']) - apv['FRAME29']['A'] / 2),
        ...
        mprog.add_offset_assembly(S_i.CONTROL_PANEL_list_normal[stamping_press_type] + '.1',
                                  ...
                                  'ZX plane', 0, 277)
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1',
                                  (apv['crankshaft']['Bx2']), 'XY plane', 0, 230)
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1', (
                    apv['crankshaft']['Ah1'] + apv['crankshaft']['Ah2'] + apv['crankshaft']['Bh1'] + apv['crankshaft'][
                'Bh2'] / 2), 'YZ plane', 0, 231)
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1', 0, 'ZX plane', 0,
        ...
        mprog.add_offset_assembly(S_i.CON_ROD_list[stamping_press_type] + '.1',
                                  S_i.CON_ROD_CAP_list[stamping_press_type] + '.1', 0, 'YZ plane', 0, 234)
        mprog.add_offset_assembly(S_i.CON_ROD_list[stamping_press_type] + '.1',
                                  S_i.CON_ROD_CAP_list[stamping_press_type] + '.1', 0, 'ZX plane', 1, 235)
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type] + '.1', 'FRAME1.1',
                                  (apv['FRAME1']['A']) + 0.5 * alpha + beta, 'XY plane', 1, 242)
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type] + '.1', 'FRAME1.1', -(
                    apv['FRAME1']['F'] - (apv['FRAME1']['aaaaa1'] + apv['FRAME1']['aaaaa2'] + apv['FRAME1']['aaaaa3']) -
                    S_assmebly_par['C_YZ']) - zeta, 'YZ plane', 0, 243)
        ...
        mprog.add_offset_assembly('BALL_SCREW.1', S_i.CON_ROD_list[stamping_press_type] + '.1', 0, 'YZ plane', 0, 294)
        mprog.add_offset_assembly('BALL_SCREW.1', S_i.CON_ROD_list[stamping_press_type] + '.1',
                                  -apv['BALL_SCREW']['Z'] / 2, 'ZX plane', 1, 295)
        if travel_type == 1:
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      -S_assmebly_par['MB_XY'], 'XY plane', 0, 323)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type] + '.1', 'FRAME20.1',
