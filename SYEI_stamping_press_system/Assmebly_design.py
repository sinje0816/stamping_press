...
def assembly(i, apv, path):
    ...
    if i == 0:
        ...
        mprog.add_offset_assembly('FRAME16.1', 'FRAME1.1',-(apv['FRAME2']['A']-apv['FRAME30']['A']-(apv['FRAME17']['g3']-apv['FRAME17']['g2'])-apv['FRAME13']['k']-apv['FRAME13']['j']-assmebly_par["Ass_V"]-assmebly_par["Ass_S"]), 'xy plane', 0, 124)
        mprog.add_offset_assembly('FRAME16.1', 'FRAME1.1',apv['FRAME2']['F']-apv['FRAME2']['G'], 'yz plane', 1, 125)
        mprog.add_offset_assembly('FRAME16.1', 'FRAME1.1',apv['FRAME1']['CC']/2+apv['FRAME13']['E'], 'zx plane', 1, 126)
