...
def assembly(stamping_press_type, apv, path, alpha, beta, zeta, epsilon, specifications_close_working_height_value, specifications_travel_value, travel_type, GUM,INVERTER, power, slide):
    ...
    for name in range(len(part_name)):
        for x in range(int(part_quantity[name])):
            if part_name[name] == 'PANEL' or part_name[name] == 'CON_ROD' or part_name[name] == 'CON_ROD_BASE' or part_name[name] == 'CON_ROD_CAP' \
                    ...
                    or part_name[name] == 'INVERTER' or part_name[name] == 'SAFETY_SWITCH' or part_name[name] == 'SAFETY_BLOCK' or part_name[name] == 'EJECTOR_UNIT'\
                    or part_name[name] == 'KNOCK_OUT_BAR' or part_name[name] == 'SlideKnockout_StrikePin' or part_name[name] == 'SlideKnockout_Bracket':#固定零件匯入清單
                # 讀取其餘STP檔
    ...
    mprog.add_offset_assembly('FRAME3.1', 'FRAME1.1', -(apv['FRAME1']['A'] - apv['FRAME3']['A'])-zeta, 'XY plane', 0, 43)
    mprog.add_offset_assembly('FRAME3.1', 'FRAME1.1', -(apv['FRAME1']['F'] - assmebly_par['Ass_F']), 'YZ plane', 0, 44)
    mprog.add_offset_assembly('FRAME3.1', 'FRAME1.1', -(apv['FRAME1']['CC'] / 2 + apv['FRAME3']['B']), 'ZX plane', 0,
                              45)
    mprog.add_offset_assembly('FRAME4.1', 'FRAME2.1', -(apv['FRAME2']['A'] - apv['FRAME4']['A'])-zeta, 'XY plane', 0, 46)
    mprog.add_offset_assembly('FRAME4.1', 'FRAME2.1', -(apv['FRAME2']['F'] - assmebly_par['Ass_G']), 'YZ plane', 0, 47)
    mprog.add_offset_assembly('FRAME4.1', 'FRAME2.1', apv['FRAME2']['CC'] / 2, 'ZX plane', 0, 48)
    mprog.add_offset_assembly('FRAME5.1', 'FRAME2.1',
                              -(apv['FRAME2']['A'] - assmebly_par['Ass_K'])-zeta, 'XY plane', 0, 70)
    ...
    mprog.add_offset_assembly('FRAME8.1', 'FRAME1.1',
                              -(apv['FRAME1']['B'] - assmebly_par['Ass_B'] - apv['FRAME8']['B']), 'YZ plane', 0, 38)
    ...
    mprog.add_offset_assembly('FRAME13.1', 'FRAME2.1', -(
                ...
                apv['FRAME13']['k'] - apv['FRAME13']['j'] - assmebly_par['Ass_V'] - assmebly_par['Ass_S'])-zeta, 'XY plane',
                              0, 121)
    mprog.add_offset_assembly('FRAME13.1', 'FRAME2.1', apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'],
                              'YZ plane', 1, 122)
    ...
    mprog.add_offset_assembly('FRAME13_1.1', 'FRAME1.1', -(
                ...
                apv['FRAME13']['k'] - apv['FRAME13']['j'] - assmebly_par['Ass_V'] - assmebly_par['Ass_S'])-zeta, 'XY plane',
                              0, 124)
    mprog.add_offset_assembly('FRAME13_1.1', 'FRAME1.1', apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'],
                              'YZ plane', 1, 125)
    ...
    mprog.add_offset_assembly('FRAME14.1', 'FRAME2.1', -(
                apv['FRAME2']['A'] - apv['FRAME30']['A'] - assmebly_par['Ass_S'] - apv['FRAME14']['g3'])-zeta, 'XY plane', 0,
                              109)
    mprog.add_offset_assembly('FRAME14.1', 'FRAME2.1',
                              apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME14']['B'] - apv['FRAME2']['FF'],
                              'YZ plane', 1, 110)
    ...
    mprog.add_offset_assembly('FRAME17.1', 'FRAME1.1', -(
                apv['FRAME1']['A'] - apv['FRAME30']['A'] - assmebly_par['Ass_S'] - apv['FRAME17']['g3'])-zeta, 'XY plane', 0,
                              112)
    mprog.add_offset_assembly('FRAME17.1', 'FRAME1.1',
                              apv['FRAME1']['F'] - apv['FRAME1']['G'] - apv['FRAME17']['B'] - apv['FRAME1']['FF'],
                              'YZ plane', 1, 113)
    mprog.add_offset_assembly('FRAME17.1', 'FRAME1.1', -(apv['FRAME2']['CC'] / 2), 'ZX plane', 0, 114)
    mprog.add_offset_assembly('FRAME18.1', 'FRAME1.1', -(
                apv['FRAME1']['A'] - assmebly_par['Ass_M'] - apv['FRAME18']['F'])-zeta, 'XY plane',
                              0, 76)
    ...
    mprog.add_offset_assembly('FRAME20.1', 'FRAME2.1', -(
                apv['FRAME1']['A'] - assmebly_par['Ass_R'] - apv['FRAME20']['H'])-zeta, 'XY plane',
                              0, 100)
    ...
    mprog.add_offset_assembly('FRAME24.1', 'FRAME30.1',
                              (apv['FRAME24']['I'] - apv['FRAME2']['CC'] + apv['FRAME24']['E']), 'ZX plane', 0, 60)
    ...
    mprog.add_offset_assembly('FRAME24_1.1', 'FRAME30.1', apv['FRAME24']['A'] + apv['FRAME30']['M'] / 2, 'YZ plane', 0,
                              62)
    mprog.add_offset_assembly('FRAME24_1.1', 'FRAME30.1', (apv['FRAME30']['E'] - (apv['FRAME24']['I'] - apv['FRAME2']['CC'])), 'ZX plane', 0,
                              63)
    ...
    mprog.add_offset_assembly('FRAME32.1', 'FRAME2.1', -(
                apv['FRAME2']['A'] - assmebly_par['Ass_K'] - apv['FRAME32']['A'])-zeta, 'XY plane',
                              0, 73)
    ...
    if stamping_press_type == 0 or stamping_press_type == 1 or stamping_press_type == 2:
        ...
        mprog.add_offset_assembly('FRAME35.1', 'FRAME1.1', (apv['FRAME1']['B'] - apv['FRAME35']['B']),
                                  'YZ plane',
                                  1, 2)
        mprog.add_offset_assembly('FRAME35.1', 'FRAME1.1',
        ...
        mprog.add_offset_assembly('FRAME35.2', 'FRAME2.1', (apv['FRAME2']['B'] - apv['FRAME35']['B']), 'YZ plane', 1, 8)
        mprog.add_offset_assembly('FRAME35.2', 'FRAME2.1',
    ...
    mprog.add_offset_assembly(S_i.slide_gib_list_left[stamping_press_type]+'.1', 'FRAME1.1', -(apv['FRAME1']['E']+apv['FRAME1']['D']+ zeta), 'XY plane', 0, 248)
    ...
    mprog.add_offset_assembly('OGASKL060_OIL_LEVEL_GAUGE.1', 'FRAME1.1', (apv['FRAME1']['A']-apv['FRAME1']['a1'])+S_assmebly_par['OLG_F_XY']+zeta, 'XY plane', 1, 254)
    ...
    mprog.add_offset_assembly(S_i.TRADEMARK_NAMEPLATE_list_normal[stamping_press_type]+'.1', 'FRAME1.1', -(apv['FRAME1']['A']-S_assmebly_par['TN_XY'])-zeta, 'XY plane', 0, 281)
    ...
    mprog.add_offset_assembly(S_i.TRADEMARK_NAMEPLATE_list_normal[stamping_press_type]+'.2', 'FRAME2.1', -(apv['FRAME1']['A']-S_assmebly_par['TN_XY'])-zeta, 'XY plane', 0, 284)
    ...
    mprog.add_offset_assembly(S_i.GUARD_FLYWHEEL_list_normal[stamping_press_type]+'.1', 'FRAME1.1', (S_assmebly_par['GF_XY'])+zeta, 'XY plane', 1, 290)
    ...
    mprog.add_offset_assembly(S_i.BALANCER_list[stamping_press_type] + '.1', 'FRAME1.1', -(apv['FRAME1']['A']-apv['FRAME1']['bbbbb']+S_assmebly_par['B_XY']+ zeta), 'XY plane', 0, 311)
    mprog.add_offset_assembly(S_i.BALANCER_list[stamping_press_type] + '.1', 'FRAME1.1', -(apv['FRAME1']['F']-apv['FRAME1']['fffff1'] + apv['FRAME1']['ddddd1'] - S_assmebly_par['B_YZ']), 'YZ plane', 0, 312)
    ...
    # 選配零件(用try防止沒有選配到該零件的時候跳錯)
    try:
        mprog.add_offset_assembly('plate.1', 'FRAME22.1', -(apv['FRAME22']['A(1)']-apv['FRAME22']['A(2)']), 'XY plane', 0, 305)
        mprog.add_offset_assembly('plate.1', 'FRAME22.1', (par.plate_length_width[1]/2-assmebly_par['Ass_AL']+apv['FRAME22']['O']), 'YZ plane', 1, 306)
        mprog.add_offset_assembly('plate.1', 'FRAME22.1', -(par.plate_length_width[0]/2-apv['FRAME22']['D']/2), 'ZX plane', 0, 307)
        if GUM == '穎益':
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      (S_assmebly_par['AVG_E_XY']+apv['FRAME10']['K(2)']), 'XY plane', 1, 341)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      (apv['FRAME10']['B']/2),
                                      'YZ plane', 0, 342)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      -(apv['FRAME10']['A']-apv['FRAME10']['a']), 'ZX plane', 0, 343)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (S_assmebly_par['AVG_E_XY']), 'XY plane', 0, 344)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (apv['FRAME10']['B']/2),
                                      'YZ plane', 0, 345)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (apv['FRAME10']['A']-apv['FRAME10']['a']), 'ZX plane', 1, 346)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (S_assmebly_par['AVG_E_XY']), 'XY plane', 0, 347)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (apv['FRAME35']['B']-apv['FRAME35']['a']-apv['FRAME35']['b']),
                                      'YZ plane', 0, 348)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (apv['FRAME35']['A']-apv['FRAME35']['e']), 'ZX plane', 1, 349)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.4', 'FRAME35.2',
                                      (S_assmebly_par['AVG_E_XY']+apv['FRAME10']['K(2)']), 'XY plane', 1, 350)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.4', 'FRAME35.2',
                                      (apv['FRAME35']['B']-apv['FRAME35']['a']-apv['FRAME35']['b']),
                                      'YZ plane', 0, 351)
            mprog.add_offset_assembly(S_i.GUM_E_list[stamping_press_type] + '.4', 'FRAME35.2',
                                      -(apv['FRAME35']['A']-apv['FRAME35']['e']), 'ZX plane', 0, 352)
        elif GUM == 'UNISORB':
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      (S_assmebly_par['AVG_U_XY']+apv['FRAME10']['K(2)']), 'XY plane', 1, 341)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      (apv['FRAME10']['B']/2),
                                      'YZ plane', 0, 342)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      -(apv['FRAME10']['A']-apv['FRAME10']['a']), 'ZX plane', 0, 343)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (S_assmebly_par['AVG_U_XY']), 'XY plane', 0, 344)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (apv['FRAME10']['B']/2),
                                      'YZ plane', 0, 345)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (apv['FRAME10']['A']-apv['FRAME10']['a']), 'ZX plane', 1, 346)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (S_assmebly_par['AVG_U_XY']), 'XY plane', 0, 347)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (apv['FRAME35']['B']-apv['FRAME35']['a']-apv['FRAME35']['b']),
                                      'YZ plane', 0, 348)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (apv['FRAME35']['A']-apv['FRAME35']['e']), 'ZX plane', 1, 349)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.4', 'FRAME35.2',
                                      (S_assmebly_par['AVG_U_XY']+apv['FRAME10']['K(2)']), 'XY plane', 1, 350)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.4', 'FRAME35.2',
                                      (apv['FRAME35']['B']-apv['FRAME35']['a']-apv['FRAME35']['b']),
                                      'YZ plane', 0, 351)
            mprog.add_offset_assembly(S_i.GUM_U_list[stamping_press_type] + '.4', 'FRAME35.2',
            ...
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      (S_assmebly_par['AVG_S_XY']+apv['FRAME10']['K(2)']), 'XY plane', 1, 341)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      (apv['FRAME10']['B']/2),
                                      'YZ plane', 0, 342)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.1', 'FRAME10.1',
                                      -(apv['FRAME10']['A']-apv['FRAME10']['a']), 'ZX plane', 0, 343)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (S_assmebly_par['AVG_S_XY']), 'XY plane', 0, 344)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (apv['FRAME10']['B']/2),
                                      'YZ plane', 0, 345)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.2', 'FRAME10.2',
                                      (apv['FRAME10']['A']-apv['FRAME10']['a']), 'ZX plane', 1, 346)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (S_assmebly_par['AVG_S_XY']), 'XY plane', 0, 347)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (apv['FRAME35']['B']-apv['FRAME35']['a']-apv['FRAME35']['b']),
                                      'YZ plane', 0, 348)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.3', 'FRAME35.1',
                                      (apv['FRAME35']['A']-apv['FRAME35']['e']), 'ZX plane', 1, 349)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.4', 'FRAME35.2',
                                      (S_assmebly_par['AVG_S_XY']+apv['FRAME10']['K(2)']), 'XY plane', 1, 350)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.4', 'FRAME35.2',
                                      (apv['FRAME35']['B']-apv['FRAME35']['a']-apv['FRAME35']['b']),
                                      'YZ plane', 0, 351)
            mprog.add_offset_assembly(S_i.GUM_S_list[stamping_press_type] + '.4', 'FRAME35.2',
    ...
    if stamping_press_type == 0:
        ...
        mprog.add_offset_assembly('FRAME27.1', 'FRAME1.1', -(apv['FRAME1']['A'] - apv['FRAME27']['A']) - zeta,
                                  'XY plane', 0,
                                  52)
        mprog.add_offset_assembly('FRAME27.1', 'FRAME1.1', -(
                apv['FRAME1']['F'] - apv['FRAME27']['B'] - apv['FRAME30']['M'] - apv['FRAME27']['J']),
                                  'YZ plane',
                                  0, 53)
        mprog.add_offset_assembly('FRAME27.1', 'FRAME1.1', -(apv['FRAME1']['CC'] / 2), 'ZX plane', 0, 54)
        mprog.add_offset_assembly('FRAME27_1.1', 'FRAME2.1', -(apv['FRAME2']['A'] - apv['FRAME27_1']['A']) - zeta,
                                  'XY plane',
                                  0, 55)
        mprog.add_offset_assembly('FRAME27_1.1', 'FRAME2.1', -(
                apv['FRAME2']['F'] - apv['FRAME27_1']['B'] - apv['FRAME30']['M'] - apv['FRAME27_1']['J']),
                                  'YZ plane', 0, 56)
        ...
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1',apv['FRAME2']['A']-apv['FRAME30']['A']-(apv['FRAME17']['g3']-apv['FRAME17']['g2'])-apv['FRAME13']['k']-apv['FRAME13']['j']-assmebly_par['Ass_V']-assmebly_par['Ass_S']+zeta, 'XY plane', 1, 127)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1',-(apv['FRAME2']['F']-apv['FRAME2']['G'] - apv['FRAME2']['FF'] -assmebly_par['Ass_T']-apv['FRAME21']['D']), 'YZ plane', 0, 128)
        ...
        mprog.add_offset_assembly('FRAME21.2', 'FRAME2.1',apv['FRAME2']['A']-apv['FRAME30']['A']-(apv['FRAME17']['g3']-apv['FRAME17']['g2'])-apv['FRAME13']['k']-apv['FRAME13']['j']-assmebly_par['Ass_V']-assmebly_par['Ass_S']+zeta, 'XY plane', 1, 130)
        mprog.add_offset_assembly('FRAME21.2', 'FRAME2.1',-(apv['FRAME2']['F']-apv['FRAME2']['G'] - apv['FRAME2']['FF'] - assmebly_par['Ass_T']-apv['FRAME21']['D']), 'YZ plane', 0, 131)
        ...
        mprog.add_offset_assembly('FRAME37.1', 'FRAME2.1', -(apv['FRAME2']['F']-apv['FRAME2']['eeee']-apv['FRAME37']['A']/2), 'YZ plane', 0, 143)
        ...
        mprog.add_offset_assembly('FRAME23.1', 'FRAME1.1', -(apv['FRAME1']['B'] - apv['FRAME23']['B']),
                                  'YZ plane', 0, 146)
        ...
        mprog.add_offset_assembly('FRAME23.2', 'FRAME1.1', -(apv["FRAME1"]["B"]-apv["FRAME23"]["B"] - assmebly_par['Ass_Y']),
                                  'YZ plane', 0, 149)
        ...
        mprog.add_offset_assembly('FRAME23.3', 'FRAME2.1', (apv['FRAME1']['B']),
                                  'YZ plane', 1, 152)
        ...
        mprog.add_offset_assembly('FRAME23.4', 'FRAME2.1', (apv["FRAME1"]["B"] - assmebly_par['Ass_Y']),
                                  'YZ plane', 1, 155)
        ...
        mprog.add_offset_assembly('FRAME15.1', 'FRAME1.1', -(
                apv['FRAME1']['A'] - apv['FRAME30']['A'] - assmebly_par['Ass_S'] - apv['FRAME17']['g3']) - zeta,
                                  'XY plane', 0,
                                  115)
        mprog.add_offset_assembly('FRAME15.1', 'FRAME1.1',
        ...
        mprog.add_offset_assembly('FRAME15.2', 'FRAME2.1', -(
                apv['FRAME2']['A'] - apv['FRAME30']['A'] - assmebly_par['Ass_S'] - apv['FRAME17']['g3']) - zeta,
                                  'XY plane', 0,
                                  118)
        mprog.add_offset_assembly('FRAME15.2', 'FRAME2.1',
    ...
    #35頓
        ...
        mprog.add_offset_assembly('FRAME6.2', 'FRAME4.1', apv['FRAME4']['B']/2+apv['FRAME6']['f'], 'ZX plane', 0, 93)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1',apv['FRAME2']['A']-apv['FRAME30']['A']-(apv['FRAME17']['g3']-apv['FRAME17']['g2'])-apv['FRAME13']['k']-apv['FRAME13']['j']-assmebly_par['Ass_V']-assmebly_par['Ass_S']+zeta, 'XY plane', 1, 127)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1',-(apv['FRAME2']['F']-apv['FRAME2']['G']-assmebly_par['Ass_T']-apv['FRAME21']['D']), 'YZ plane', 0, 128)
        mprog.add_offset_assembly('FRAME21.1', 'FRAME1.1',-(apv['FRAME3']['B']/2-assmebly_par['Ass_U']+apv['FRAME1']['CC']/2-apv['FRAME21']['C']), 'ZX plane', 0, 129)
        mprog.add_offset_assembly('FRAME21.2', 'FRAME2.1',apv['FRAME2']['A']-apv['FRAME30']['A']-(apv['FRAME17']['g3']-apv['FRAME17']['g2'])-apv['FRAME13']['k']-apv['FRAME13']['j']-assmebly_par['Ass_V']-assmebly_par['Ass_S']+zeta, 'XY plane', 1, 130)
        mprog.add_offset_assembly('FRAME21.2', 'FRAME2.1',-(apv['FRAME2']['F']-apv['FRAME2']['G']-assmebly_par['Ass_T']-apv['FRAME21']['D']), 'YZ plane', 0, 131)
        mprog.add_offset_assembly('FRAME21.2', 'FRAME2.1',(apv['FRAME3']['B']/2-assmebly_par['Ass_U']+apv['FRAME1']['CC']/2), 'ZX plane', 0, 132)
        mprog.add_offset_assembly('FRAME37.1', 'FRAME2.1', -(apv['FRAME2']['A']-apv['FRAME2']['ffff']-apv['FRAME37']['A']/2), 'XY plane', 0, 142)
        mprog.add_offset_assembly('FRAME37.1', 'FRAME2.1', -(apv['FRAME2']['F']-apv['FRAME2']['eeee']-apv['FRAME37']['A']/2), 'YZ plane', 0, 143)
        mprog.add_offset_assembly('FRAME37.1', 'FRAME2.1', apv['FRAME2']['CC']/2, 'ZX plane', 0, 144)
        ...
        mprog.add_offset_assembly('FRAME41.2', 'FRAME2.1', (
                apv['FRAME2']['A']-apv['FRAME30']['A']-(apv['FRAME17']['g3']-apv['FRAME17']['g2'])-apv['FRAME13']['k']-apv['FRAME13']['j']-assmebly_par['Ass_V']-assmebly_par['Ass_S']+zeta+apv['FRAME41']['I']),
                                  'XY plane', 1,
                                  161)
        ...
        mprog.add_offset_assembly('FRAME41.1', 'FRAME1.1', -(
                apv['FRAME2']['A']-apv['FRAME30']['A']-(apv['FRAME17']['g3']-apv['FRAME17']['g2'])-apv['FRAME13']['k']-apv['FRAME13']['j']-assmebly_par['Ass_V']-assmebly_par['Ass_S']+zeta),
                                  'XY plane', 0,
                                  164)
    ...
    #45頓
        ...
        mprog.add_offset_assembly('FRAME15.4', 'FRAME2.1', apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                    apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + apv['FRAME15']['A'] + zeta, 'XY plane', 1, 130)
        mprog.add_offset_assembly('FRAME15.4', 'FRAME2.1', -(
                    apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'] - assmebly_par['Ass_T'] -
                    apv['FRAME15']['C']), 'YZ plane', 0, 131)
        mprog.add_offset_assembly('FRAME15.4', 'FRAME2.1',
                                  -(apv['FRAME3']['B'] / 2 - assmebly_par['Ass_U'] + apv['FRAME1']['CC'] / 2),
                                  'ZX plane', 1, 132)
        ...
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', 0, 'XY plane', 0, 19)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', -(apv['FRAME1']['B'] - apv['FRAME33']['B']),
                                  'YZ plane', 0, 20)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', -(apv['FRAME33']['K'] + apv['FRAME1']['CC'] / 2), 'ZX plane',
                                  0, 21)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', 0, 'XY plane', 0, 22)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', -(apv['FRAME2']['B'] - apv['FRAME34']['B']),
                                  'YZ plane', 0, 23)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', apv['FRAME2']['CC'] / 2, 'ZX plane', 0, 24)
        ...
        mprog.add_offset_assembly('FRAME37.1', 'FRAME2.1',
                                  ...
                                  0, 142)
        mprog.add_offset_assembly('FRAME37.1', 'FRAME2.1',
                                  -(apv['FRAME2']['F'] - apv['FRAME2']['eeee'] - apv['FRAME37']['A'] / 2),
                                  'YZ plane', 0, 143)
        mprog.add_offset_assembly('FRAME37.1', 'FRAME2.1', apv['FRAME2']['CC'] / 2, 'ZX plane', 0, 144)
        mprog.add_offset_assembly('FRAME23.1', 'FRAME1.1',
                                  -(apv["FRAME1"]["E"] - apv["FRAME1"]["DD"] - apv["FRAME23"]["I"]), 'XY plane', 0, 145)
        ...
        mprog.add_offset_assembly('FRAME23.2', 'FRAME1.1',
                                  -(apv["FRAME1"]["E"] - apv["FRAME1"]["DD"] - apv["FRAME23"]["I"]), 'XY plane', 0, 148)
        mprog.add_offset_assembly('FRAME23.2', 'FRAME1.1',
                                  -(apv["FRAME1"]["B"] - apv["FRAME23"]["B"] - assmebly_par['Ass_Y']),
                                  'YZ plane', 0, 149)
        mprog.add_offset_assembly('FRAME23.2', 'FRAME1.1', -(apv['FRAME1']['CC'] / 2 + apv['FRAME23']['A']), 'ZX plane',
                                  1, 150)
        mprog.add_offset_assembly('FRAME23.3', 'FRAME2.1',
        ...
        mprog.add_offset_assembly('FRAME42.1', 'FRAME1.1', (apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  ...
                                  apv['FRAME42']['A'] / 2 + zeta), 'XY plane', 1, 167)
        mprog.add_offset_assembly('FRAME42.1', 'FRAME1.1', -(
                apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'] - assmebly_par['Ass_T'] -
                apv['FRAME15']['C'] - apv['FRAME42']['C']), 'YZ plane', 0, 168)
        mprog.add_offset_assembly('FRAME42.1', 'FRAME1.1', -(
        ...
        mprog.add_offset_assembly('FRAME42.2', 'FRAME2.1', apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + apv['FRAME15']['A'] / 2 -
                                  apv['FRAME42']['A'] / 2 + zeta, 'XY plane', 1, 170)
        mprog.add_offset_assembly('FRAME42.2', 'FRAME2.1', -(
                apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'] - assmebly_par['Ass_T'] -
                apv['FRAME15']['C'] - apv['FRAME42']['C']), 'YZ plane', 0, 171)
        mprog.add_offset_assembly('FRAME42.2', 'FRAME2.1', (
    ...
    #60頓待修
        ...
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1',
                                  ...
                                  99)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', 0, 'XY plane', 0, 19)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', -(apv['FRAME1']['B'] - apv['FRAME33']['B'] - apv['FRAME33']['M'] - apv['FRAME33']['O']),
                                  'YZ plane', 0, 20)
        mprog.add_offset_assembly('FRAME33.1', 'FRAME1.1', -(apv['FRAME33']['K'] + apv['FRAME1']['CC'] / 2), 'ZX plane',
                                  0, 21)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', 0, 'XY plane', 0, 22)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', -(apv['FRAME2']['B'] - apv['FRAME34']['B'] - apv['FRAME34']['Q'] - apv['FRAME34']['S']),
                                  'YZ plane', 0, 23)
        mprog.add_offset_assembly('FRAME34.1', 'FRAME2.1', apv['FRAME2']['CC'] / 2, 'ZX plane', 0, 24)
        mprog.add_offset_assembly('FRAME36.1', 'FRAME4.1', -(
                (assmebly_par['Ass_J'] - apv['FRAME36']['A'] / 2) + (apv['FRAME4']['A'] - apv['FRAME4']['a'])),
    ...
    #110頓
        ...
        mprog.add_offset_assembly('FRAME52.1', 'FRAME22.1', apv["FRAME19"]["AH"]+apv["FRAME52"]["A"], 'ZX plane', 0, 214)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1',
                                  -(apv["FRAME22"]["A(1)"] - apv["FRAME22"]["A(2)"] - apv["FRAME52"]["C"]), 'XY plane',
                                  0, 215)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1', -(apv["FRAME52"]["B"]), 'YZ plane', 1, 216)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1', -(apv["FRAME22"]["D"] - apv["FRAME19"]["AH"]-apv["FRAME52"]["A"]), 'ZX plane', 1,
                                  217)
        #STP組立部分
        ...
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type]+'.1', 'FRAME1.1', -(apv['FRAME1']['A'])-zeta, 'XY plane', 0, 242)
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type]+'.1', 'FRAME1.1', -(apv['FRAME1']['F']-(apv['FRAME1']['fffff1']+apv['FRAME1']['fffff2'])+S_assmebly_par['C_YZ']), 'YZ plane', 0, 243)
        ...
        if travel_type == 1:
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', 'FRAME20.1', -S_assmebly_par['MB_XY'], 'XY plane', 0, 323)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', 'FRAME20.1', S_assmebly_par['MB_YZ'], 'YZ plane', 0, 324)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', 'FRAME20.1', -S_assmebly_par['MB_ZX'], 'ZX plane', 0, 325)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', S_assmebly_par['M_XY'], 'XY plane', 1, 326)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', -S_assmebly_par['M_YZ'], 'YZ plane', 0, 327)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', S_assmebly_par['M_ZX'], 'ZX plane', 0, 328)
        else:
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', 'FRAME20.1', S_assmebly_par['MB_XY'], 'XY plane', 1, 323)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', 'FRAME20.1', S_assmebly_par['MB_YZ'], 'YZ plane', 0, 324)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', 'FRAME20.1', -S_assmebly_par['MB_ZX'], 'ZX plane', 0, 325)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', S_assmebly_par['M_XY'], 'XY plane', 0, 326)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', -S_assmebly_par['M_YZ'], 'YZ plane', 0, 327)
        ...
        mprog.add_offset_assembly('FRAME6.1', 'FRAME19.1', (apv["FRAME19"]["A"] - apv["FRAME19"]["J"]), 'XY plane',
                                  1, 356)
        mprog.add_offset_assembly('FRAME6.1', 'FRAME19.1', (apv["FRAME19"]["L"]), 'YZ plane', 1, 357)
        mprog.add_offset_assembly('FRAME6.1', 'FRAME19.1', (apv["FRAME19"]["AH"] - apv["FRAME6"]["B"]), 'ZX plane',
                                  0, 358)
        mprog.add_offset_assembly('FRAME6.2', 'FRAME19.2',
                                  -(apv["FRAME19"]["A"] - apv["FRAME19"]["J"] - apv["FRAME19"]["K"]), 'XY plane', 0,
                                  359)
        mprog.add_offset_assembly('FRAME6.2', 'FRAME19.2', (apv["FRAME19"]["L"]), 'YZ plane', 1, 360)
        mprog.add_offset_assembly('FRAME6.2', 'FRAME19.2', -(apv["FRAME6"]["B"]), 'ZX plane', 1, 361)
        mprog.add_offset_assembly('FRAME11.1', 'FRAME3.1',
                                  -(apv['FRAME3']['A'] - apv['FRAME3']['E'] - apv['FRAME11']['A'] / 2), 'XY plane',
                                  0, 362)
        mprog.add_offset_assembly('FRAME11.1', 'FRAME3.1', apv['FRAME3']['O'] + assmebly_par['Ass_I'], 'YZ plane',
                                  0, 363)
        mprog.add_offset_assembly('FRAME11.1', 'FRAME3.1', apv['FRAME3']['B'] / 2 + apv['FRAME11']['A'] / 2,
                                  'ZX plane', 0, 364)
        mprog.add_offset_assembly('FRAME23_1.1', 'FRAME22.1',
                                  -(apv["FRAME22"]["A(1)"] - apv["FRAME22"]["A(2)"] - apv["FRAME23"]["I"]),
                                  'XY plane', 0, 365)
        mprog.add_offset_assembly('FRAME23_1.1', 'FRAME22.1', -(apv["FRAME22"]["O"] + apv["FRAME23"]["A"]),
                                  'YZ plane', 0, 366)
        mprog.add_offset_assembly('FRAME23_1.1', 'FRAME22.1', (apv["FRAME22"]["D"] / 2 + apv["FRAME23"]["B"] / 2),
                                  'ZX plane', 0, 367)
        mprog.add_offset_assembly('FRAME15.1', 'FRAME1.1', -(
                apv['FRAME1']['A'] - apv['FRAME30']['A'] - assmebly_par['Ass_S'] - apv['FRAME17']['g3']) - beta,
                                  'XY plane', 0,
                                  368)
        mprog.add_offset_assembly('FRAME15.1', 'FRAME1.1', -(apv['FRAME1']['F'] - assmebly_par['Ass_F']) - zeta,
                                      'YZ plane', 0, 369)
        mprog.add_offset_assembly('FRAME15.1', 'FRAME1.1',
                                      -(apv['FRAME3']['B'] / 2 - assmebly_par['Ass_U'] + apv['FRAME1']['CC'] / 2),
                                      'ZX plane', 0, 370)
        mprog.add_offset_assembly('FRAME15.2', 'FRAME2.1', -(
                apv['FRAME2']['A'] - apv['FRAME30']['A'] - assmebly_par['Ass_S'] - apv['FRAME17']['g3']) - beta,
                                  ...
                                  371)
        mprog.add_offset_assembly('FRAME15.2', 'FRAME2.1',
                                  -(apv['FRAME1']['F'] - assmebly_par['Ass_F']) - zeta,
                                  'YZ plane', 0, 372)
        mprog.add_offset_assembly('FRAME15.2', 'FRAME2.1',
                                  (apv['FRAME3']['B'] / 2 - assmebly_par['Ass_U'] + apv['FRAME1']['CC'] / 2 -
                                      apv['FRAME15']['B']),
        ...
        mprog.add_offset_assembly('FRAME15.3', 'FRAME1.1', apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + apv['FRAME15']['A'] + beta,
                                  'XY plane', 1, 374)
        mprog.add_offset_assembly('FRAME15.3', 'FRAME1.1', -(apv['FRAME1']['F'] - assmebly_par['Ass_F']) - zeta,
                                  'YZ plane', 0, 375)
        mprog.add_offset_assembly('FRAME15.3', 'FRAME1.1', (
                apv['FRAME3']['B'] / 2 - assmebly_par['Ass_U'] + apv['FRAME1']['CC'] / 2 - apv['FRAME15']['B']),
                                  'ZX plane', 1, 376)
        mprog.add_offset_assembly('FRAME15.4', 'FRAME2.1', apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + apv['FRAME15']['A'] + beta,
                                  'XY plane', 1, 377)
        mprog.add_offset_assembly('FRAME15.4', 'FRAME2.1', -(apv['FRAME1']['F'] - assmebly_par['Ass_F']) - zeta,
                                  'YZ plane', 0, 378)
        mprog.add_offset_assembly('FRAME15.4', 'FRAME2.1',
                                  -(apv['FRAME3']['B'] / 2 - assmebly_par['Ass_U'] + apv['FRAME1']['CC'] / 2),
                                  'ZX plane', 1, 379)
        mprog.add_offset_assembly('FRAME29.1', 'FRAME4.1', -(
                    assmebly_par['Ass_Q'] + (apv['FRAME4']['A'] - apv['FRAME4']['a']) - apv['FRAME29']['A'] / 2),
                                  'XY plane', 0, 380)
        mprog.add_offset_assembly('FRAME29.1', 'FRAME4.1', (apv['FRAME29']['B'] - apv['FRAME29']['F']), 'YZ plane',
                                  1, 381)
        mprog.add_offset_assembly('FRAME29.1', 'FRAME4.1',
                                  -(apv['FRAME4']['B'] / 2 - apv['FRAME6']['e'] - apv['FRAME29']['A'] / 2),
                                  'ZX plane', 1, 382)
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1', -(
                    assmebly_par['Ass_Q'] + (apv['FRAME4']['A'] - apv['FRAME4']['a']) - apv['FRAME29']['A'] / 2),
                                  'XY plane', 0, 383)
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1', (apv['FRAME29']['B'] - apv['FRAME29']['F']), 'YZ plane',
                                  1, 384)
        mprog.add_offset_assembly('FRAME29.2', 'FRAME4.1',
                                  -(apv['FRAME4']['B'] / 2 + apv['FRAME6']['e'] - apv['FRAME29']['A'] / 2),
                                  'ZX plane', 1, 385)
        mprog.add_offset_assembly('FRAME43.1', 'FRAME13.1',
                                  apv["FRAME13"]["j"] + apv["FRAME13"]["k"] + assmebly_par['Ass_AI'] +
                                  apv["FRAME43"]["C"] / 2, 'XY plane', 1, 386)
        mprog.add_offset_assembly('FRAME43.1', 'FRAME13.1', apv["FRAME43"]["B"] - apv["FRAME43"]["F"], 'YZ plane',
                                  1, 387)
        mprog.add_offset_assembly('FRAME43.1', 'FRAME13.1', 0, 'ZX plane', 0, 388)
        mprog.add_offset_assembly('FRAME43.2', 'FRAME13_1.1', -(
                    apv["FRAME13"]["j"] + apv["FRAME13"]["k"] + assmebly_par['Ass_AI'] - apv["FRAME43"]["C"]),
                                  'XY plane', 0, 389)
        mprog.add_offset_assembly('FRAME43.2', 'FRAME13_1.1', apv["FRAME43"]["B"] - apv["FRAME43"]["F"], 'YZ plane',
                                  1, 390)
        mprog.add_offset_assembly('FRAME43.2', 'FRAME13_1.1', apv["FRAME13"]["E"], 'ZX plane', 1, 391)
        mprog.add_offset_assembly('FRAME47.1', 'FRAME22.1',
                                  -(apv["FRAME22"]["A(1)"] - apv["FRAME22"]["A(2)"] - apv["FRAME47"]["E"]),
                                  'XY plane', 0, 392)
        mprog.add_offset_assembly('FRAME47.1', 'FRAME7.1', -apv["FRAME47"]["B"], 'YZ plane', 1, 393)
        mprog.add_offset_assembly('FRAME47.1', 'FRAME22.1', -(apv["FRAME22"]["D"] / 2 - apv["FRAME47"]["B"] / 2),
                                  'ZX plane', 1, 394)
        mprog.add_offset_assembly('FRAME48.1', 'FRAME8.1', (apv["FRAME48"]["B"]), 'XY plane', 0, 395)
        mprog.add_offset_assembly('FRAME48.1', 'FRAME8.1', apv["FRAME48"]["C"], 'YZ plane', 1, 396)
        mprog.add_offset_assembly('FRAME48.1', 'FRAME8.1', 0, 'ZX plane', 1, 397)
        mprog.add_offset_assembly('FRAME48.2', 'FRAME8.1', (apv["FRAME48"]["B"]), 'XY plane', 0, 398)
        mprog.add_offset_assembly('FRAME48.2', 'FRAME8.1', (assmebly_par['Ass_AF'] + apv["FRAME48"]["C"]),
                                  'YZ plane', 1, 399)
        mprog.add_offset_assembly('FRAME48.2', 'FRAME8.1', 0, 'ZX plane', 1, 400)
        mprog.add_offset_assembly('FRAME49.1', 'FRAME4.1', -(apv["FRAME4"]["k"] + assmebly_par['Ass_AE']),
                                  'XY plane', 0, 401)
        mprog.add_offset_assembly('FRAME49.1', 'FRAME4.1', 0, 'YZ plane', 1, 402)
        mprog.add_offset_assembly('FRAME49.1', 'FRAME4.1', -(apv['FRAME4']['B'] / 2 - assmebly_par['Ass_AD']),
                                  'ZX plane', 1, 403)
        mprog.add_offset_assembly('FRAME50.1', 'FRAME4.1',
                                  -(apv["FRAME4"]["k"] + assmebly_par['Ass_AC'] - apv["FRAME50"]["B"] / 2),
                                  'XY plane', 0, 404)
        mprog.add_offset_assembly('FRAME50.1', 'FRAME4.1', -(apv["FRAME50"]["c"]), 'YZ plane', 1, 405)
        mprog.add_offset_assembly('FRAME50.1', 'FRAME4.1',
                                  -(apv['FRAME4']['B'] / 2 - assmebly_par['Ass_AB'] + apv['FRAME50']['B'] / 2),
                                  'ZX plane', 1, 406)
        mprog.add_offset_assembly('FRAME52.1', 'FRAME22.1',
                                  -(apv["FRAME22"]["A(1)"] - apv["FRAME22"]["A(2)"] - apv["FRAME52"]["C"]),
                                  'XY plane', 0, 407)
        mprog.add_offset_assembly('FRAME52.1', 'FRAME22.1', 0, 'YZ plane', 0, 408)
        # mprog.add_offset_assembly('FRAME52.1', 'FRAME22.1', apv["FRAME22"]["D"] - apv["FRAME19"]["AH"], 'ZX plane', 0,409)
        mprog.add_offset_assembly('FRAME52.1', 'FRAME22.1', apv["FRAME19"]["AH"] + apv["FRAME52"]["A"], 'ZX plane',
                                  0, 214)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1',
                                  -(apv["FRAME22"]["A(1)"] - apv["FRAME22"]["A(2)"] - apv["FRAME52"]["C"]),
                                  'XY plane', 0, 410)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1', -(apv["FRAME52"]["B"]), 'YZ plane', 1, 411)
        # mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1', -(apv["FRAME19"]["AH"]), 'ZX plane', 1,412)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1',
                                  -(apv["FRAME22"]["D"] - apv["FRAME19"]["AH"] - apv["FRAME52"]["A"]), 'ZX plane',
                                  1, 217)
        mprog.add_offset_assembly('FRAME53.1', 'FRAME11.1', -(apv["FRAME11"]["A"] / 2 + 132.31), 'XY plane', 0, 413)
        mprog.add_offset_assembly('FRAME53.1', 'FRAME11.1', -(
                    apv["FRAME11"]["B"] - apv["FRAME53"]["B"] - (assmebly_par['Ass_AJ'] - apv["FRAME53"]["B"])),
                                  'YZ plane', 0, 414)
        mprog.add_offset_assembly('FRAME53.1', 'FRAME11.1', (apv["FRAME11"]["A"] / 2 + 90.51), 'ZX plane', 1, 415)
        mprog.add_offset_assembly('FRAME53_1.1', 'FRAME11.1', (apv["FRAME11"]["A"] / 2 + 149.8), 'XY plane', 1, 416)
        mprog.add_offset_assembly('FRAME53_1.1', 'FRAME11.1', -(
                    apv["FRAME11"]["B"] - apv["FRAME53"]["B"] - (assmebly_par['Ass_AJ'] - apv["FRAME53"]["B"])),
                                  'YZ plane', 0, 417)
        mprog.add_offset_assembly('FRAME53_1.1', 'FRAME11.1', (apv["FRAME11"]["A"] / 2 - 60.5), 'ZX plane', 1, 418)
        mprog.add_offset_assembly('FRAME54.1', 'FRAME30.1', -(apv['FRAME30']['h'] - apv['FRAME54']['D']),
                                  'XY plane', 0, 419)
        mprog.add_offset_assembly('FRAME54.1', 'FRAME30.1', apv['FRAME30']['M'] / 2 + apv['FRAME54']['F'],
                                  'YZ plane', 0, 420)
        mprog.add_offset_assembly('FRAME54.1', 'FRAME30.1', apv['FRAME30']['E'] / 2 - apv['FRAME30']['i(2)'],
                                  'ZX plane', 0, 421)
        mprog.add_offset_assembly('FRAME45.1', 'FRAME13.1', 0, 'XY plane', 0, 422)
        mprog.add_offset_assembly('FRAME45.1', 'FRAME13.1', apv["FRAME45"]["A"] + apv["FRAME13"]["H"], 'YZ plane',
                                  1, 423)
        mprog.add_offset_assembly('FRAME45.1', 'FRAME13.1',
                                      -apv["FRAME45"]["C"] - (apv['FRAME13']['E'] - apv['FRAME13_1']['E']), 'ZX plane',
                                      0, 424)
        mprog.add_offset_assembly('FRAME45.2', 'FRAME13_1.1', apv["FRAME45"]["H"], 'XY plane', 1, 425)
        mprog.add_offset_assembly('FRAME45.2', 'FRAME13_1.1', apv["FRAME45"]["A"] + apv["FRAME13"]["H"], 'YZ plane',
                                  1, 426)
        mprog.add_offset_assembly('FRAME45.2', 'FRAME13_1.1', -(apv["FRAME45"]["C"] - apv["FRAME13_1"]["E"]),
                                  'ZX plane', 1, 427)
        mprog.add_offset_assembly('FRAME23.1', 'FRAME1.1',
                                  -(apv["FRAME1"]["E"] - apv["FRAME1"]["DD"] - apv["FRAME23"]["I"]), 'XY plane', 0,
                                  428)
        mprog.add_offset_assembly('FRAME23.1', 'FRAME1.1', -(apv['FRAME1']['B'] - apv['FRAME23']['B']) - zeta,
                                  'YZ plane', 0, 429)
        mprog.add_offset_assembly('FRAME23.1', 'FRAME1.1', -(apv['FRAME1']['CC'] / 2 + apv['FRAME23']['A']),
                                  'ZX plane', 1, 430)
        mprog.add_offset_assembly('FRAME23.2', 'FRAME1.1',
                                  -(apv["FRAME1"]["E"] - apv["FRAME1"]["DD"] - apv["FRAME23"]["I"]), 'XY plane', 0,
                                  431)
        mprog.add_offset_assembly('FRAME23.2', 'FRAME1.1',
                                  ...
                                  'YZ plane', 0, 432)
        mprog.add_offset_assembly('FRAME23.2', 'FRAME1.1', -(apv['FRAME1']['CC'] / 2 + apv['FRAME23']['A']),
                                  'ZX plane', 1, 433)
        mprog.add_offset_assembly('FRAME23.3', 'FRAME2.1',
                                  -(apv["FRAME1"]["E"] - apv["FRAME1"]["DD"] - apv["FRAME23"]["I"]), 'XY plane', 0,
                                  434)
        mprog.add_offset_assembly('FRAME23.3', 'FRAME2.1', (apv['FRAME1']['B']) + zeta, 'YZ plane', 1, 435)
        mprog.add_offset_assembly('FRAME23.3', 'FRAME2.1', -(apv['FRAME1']['CC'] / 2 + apv['FRAME23']['A']),
                                  'ZX plane', 0, 436)
        mprog.add_offset_assembly('FRAME23.4', 'FRAME2.1',
                                  -(apv["FRAME1"]["E"] - apv["FRAME1"]["DD"] - apv["FRAME23"]["I"]), 'XY plane', 0,
                                  437)
        mprog.add_offset_assembly('FRAME23.4', 'FRAME2.1', (apv["FRAME1"]["B"] - assmebly_par['Ass_Y']) + zeta,
                                  'YZ plane', 1, 438)
        mprog.add_offset_assembly('FRAME23.4', 'FRAME2.1', -(apv['FRAME2']['CC'] / 2 + apv['FRAME23']['A']),
                                  'ZX plane', 0, 439)
        if travel_type == 1:
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type] + '.1', 'FRAME20.1',
                                          -S_assmebly_par['MB_XY'], 'XY plane', 0, 323)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      S_assmebly_par['MB_YZ'], 'YZ plane', 0, 324)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      S_assmebly_par['MB_ZX'], 'ZX plane', 0, 325)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_S_list[stamping_press_type] + '.1', -S_assmebly_par['M_XY'],
                                      'XY plane', 0, 326)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_S_list[stamping_press_type] + '.1', -S_assmebly_par['M_YZ'],
                                      'YZ plane', 0, 327)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_S_list[stamping_press_type] + '.1', -S_assmebly_par['M_ZX'],
                                      'ZX plane', 0, 328)
        else:
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      -S_assmebly_par['MB_XY'], 'XY plane', 0, 323)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      S_assmebly_par['MB_YZ'], 'YZ plane', 0, 324)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1', 'FRAME20.1',
                                      -S_assmebly_par['MB_ZX'], 'ZX plane', 1, 325)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1',
                                      -S_assmebly_par['M_XY'], 'XY plane', 0, 326)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1',
                                      -S_assmebly_par['M_YZ'], 'YZ plane', 0, 327)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type] + '.1',
                                      S_i.MOTOR_BRACKET_HP_list[stamping_press_type] + '.1',
                                      -S_assmebly_par['M_ZX'], 'ZX plane', 1, 328)
            # 變頻器選配
        if INVERTER == '東元':
            if power == '220Vx60Hz' or power == '220x50Hz':
                mprog.add_offset_assembly(S_i.INVERTER_D_S_list[stamping_press_type] + '.1', 'FRAME2.1', -(
                        apv['FRAME2']['w4'] + apv['FRAME2']['w3'] + apv['FRAME2']['aaa2'] + apv['FRAME2'][
                    'aaa1'] / 2), 'XY plane', 0, 353)
                mprog.add_offset_assembly(S_i.INVERTER_D_S_list[stamping_press_type] + '.1', 'FRAME2.1',
            ...
            if power == '220Vx60Hz' or power == '220x50Hz':
                ...
                mprog.add_offset_assembly(S_i.INVERTER_440_T_S_list[stamping_press_type] + '.1', 'FRAME2.1',
                                          -(apv['FRAME2']['CC'] / 2), 'ZX plane', 0, 355)
        # STP組立
        mprog.add_offset_assembly(S_i.CON_ROD_list[stamping_press_type] + '.1',
                                  S_i.CON_ROD_CAP_list[stamping_press_type] + '.1', (S_assmebly_par['C_R_XY']),
                                  'XY plane', 0, 233)
        mprog.add_offset_assembly(S_i.CON_ROD_list[stamping_press_type] + '.1',
                                  S_i.CON_ROD_CAP_list[stamping_press_type] + '.1', 0, 'YZ plane', 0, 234)
        mprog.add_offset_assembly(S_i.CON_ROD_list[stamping_press_type] + '.1',
                                  S_i.CON_ROD_CAP_list[stamping_press_type] + '.1', 0, 'ZX plane', 0, 235)
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1',
                                  (apv['crankshaft']['Bx2'] + alpha / 2), 'XY plane', 0, 230)
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1', -(
                    apv['crankshaft']['Ah1'] + apv['crankshaft']['Ah2'] + apv['crankshaft']['Bh1'] +
                    apv['crankshaft']['Bh2'] / 2), 'YZ plane', 1, 231)
        mprog.add_offset_assembly(S_i.CON_ROD_BASE_list[stamping_press_type] + '.1', 'crankshaft.1', 0, 'ZX plane',
                                  0, 232)
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type] + '.1', 'FRAME1.1',
                                  -(apv['FRAME1']['A']) + 0.5 * alpha + beta, 'XY plane', 0, 242)
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type] + '.1', 'FRAME1.1', -(apv['FRAME1']['F'] - (
                    apv['FRAME1']['aaaaa1'] + apv['FRAME1']['aaaaa2'] + apv['FRAME1']['aaaaa3']) - S_assmebly_par[
                                                                                                'C_YZ']) - zeta,
                                  'YZ plane', 0, 243)
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type] + '.1', 'FRAME1.1', -S_assmebly_par['C_ZX'],
                                  'ZX plane', 1, 244)
        mprog.add_offset_assembly(S_i.PLUG_list + '.1', S_i.COVER_list[stamping_press_type] + '.1',
                                  -(S_assmebly_par['P_XY']), 'XY plane', 0, 245)
        mprog.add_offset_assembly(S_i.PLUG_list + '.1', S_i.COVER_list[stamping_press_type] + '.1',
                                  (S_assmebly_par['P_YZ']), 'YZ plane', 0, 246)
        mprog.add_offset_assembly(S_i.PLUG_list + '.1', S_i.COVER_list[stamping_press_type] + '.1',
                                  -(S_assmebly_par['P_ZX']), 'ZX plane', 1, 247)
        mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_CON_ROD[stamping_press_type] + '.1',
                                  S_i.CON_ROD_list[stamping_press_type] + '.1', -(S_assmebly_par['PLG_C_XY']),
                                  'XY plane', 1, 257)
        mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_CON_ROD[stamping_press_type] + '.1',
                                  S_i.CON_ROD_list[stamping_press_type] + '.1', -(S_assmebly_par['PLG_C_YZ']),
                                  'YZ plane', 0, 258)
        mprog.add_offset_assembly(S_i.OIL_LEVEL_GAUGE_list_CON_ROD[stamping_press_type] + '.1',
                                  S_i.CON_ROD_list[stamping_press_type] + '.1', (S_assmebly_par['PLG_C_ZX']),
                                  'ZX plane', 0, 259)
        ...
        mprog.add_offset_assembly(S_i.PANEL_BOX_BRACKET_list_normal[stamping_press_type] + '.1',
                                  S_i.ELECTRIC_BOX_list_normal[stamping_press_type] + '.1',
                                  (S_assmebly_par['PBB_ZX']), 'ZX plane', 1, 271)
        ...
        mprog.add_offset_assembly(S_i.PANEL_BOX_list_normal[stamping_press_type] + '.1',
                                  S_i.PANEL_BOX_BRACKET_list_normal[stamping_press_type] + '.1',
                                  -(S_assmebly_par['PB_ZX']), 'ZX plane', 1, 274)
        mprog.add_offset_assembly(S_i.CONTROL_PANEL_list_normal[stamping_press_type] + '.1',
                                  S_i.PANEL_BOX_list_normal[stamping_press_type] + '.1', -(S_assmebly_par['CP_XY']),
                                  'XY plane', 0, 275)
        mprog.add_offset_assembly(S_i.CONTROL_PANEL_list_normal[stamping_press_type] + '.1',
                                  S_i.PANEL_BOX_list_normal[stamping_press_type] + '.1', (S_assmebly_par['CP_YZ']),
                                  'YZ plane', 0, 276)
        mprog.add_offset_assembly(S_i.CONTROL_PANEL_list_normal[stamping_press_type] + '.1',
                                  S_i.PANEL_BOX_list_normal[stamping_press_type] + '.1', (S_assmebly_par['CP_ZX']),
                                  'ZX plane', 0, 277)
        # mprog.add_offset_assembly('BALL_SCREW.1', S_i.CON_ROD_list[stamping_press_type] + '.1',
        #                           (assmebly_par['Ass_AK']), 'XY plane', 0, 293)
        mprog.add_offset_assembly('BALL_SCREW.1', 'slide.1',-(S_assmebly_par['BS_XY'] - apv['BALL_SCREW']['Z'] / 2),
                                  'XY plane', 0, 293)
        mprog.add_offset_assembly('BALL_SCREW.1', S_i.CON_ROD_list[stamping_press_type] + '.1', 0, 'YZ plane', 0,
                                  294)
        mprog.add_offset_assembly('BALL_SCREW.1', S_i.CON_ROD_list[stamping_press_type] + '.1',
                                  -apv['BALL_SCREW']['Z'] / 2, 'ZX plane', 0, 295)
    ...
    #250頓
        ...
        mprog.add_offset_assembly('FRAME51.1', 'FRAME1.1', -(apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                    apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + apv['FRAME15']['A'] - apv['FRAME51']['A']  + zeta), 'XY plane', 0, 127)
        mprog.add_offset_assembly('FRAME51.1', 'FRAME1.1', -(
            apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'] - assmebly_par[
                'Ass_T'] - apv['FRAME15']['F']), 'YZ plane', 0, 128)
        mprog.add_offset_assembly('FRAME51.1', 'FRAME1.1', -(
        ...
        mprog.add_offset_assembly('FRAME51_1.1', 'FRAME2.1', -(apv['FRAME2']['A'] - apv['FRAME30']['A'] - (
                    apv['FRAME17']['g3'] - apv['FRAME17']['g2']) - apv['FRAME13']['k'] - apv['FRAME13']['j'] -
                                  assmebly_par['Ass_V'] - assmebly_par['Ass_S'] + apv['FRAME15']['A'] - apv['FRAME51']['A'] + zeta), 'XY plane', 0, 130)
        mprog.add_offset_assembly('FRAME51_1.1', 'FRAME2.1', -(
            apv['FRAME2']['F'] - apv['FRAME2']['G'] - apv['FRAME2']['FF'] - assmebly_par[
                'Ass_T'] - apv['FRAME15']['F']), 'YZ plane', 0, 131)
        mprog.add_offset_assembly('FRAME51_1.1', 'FRAME2.1',
        ...
        mprog.add_offset_assembly('FRAME52.1', 'FRAME22.1',
                                  ...
                                  0, 212)
        mprog.add_offset_assembly('FRAME52.1', 'FRAME22.1', 0, 'YZ plane', 0, 213)
        mprog.add_offset_assembly('FRAME52.1', 'FRAME22.1', apv["FRAME19"]["AH"] + apv["FRAME52"]["A"], 'ZX plane', 0,
                                  214)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1',
                                  -(apv["FRAME22"]["A(1)"] - apv["FRAME22"]["A(2)"] - apv["FRAME52"]["C"]), 'XY plane',
                                  0, 215)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1', -(apv["FRAME52"]["B"]), 'YZ plane', 1, 216)
        mprog.add_offset_assembly('FRAME52.2', 'FRAME22.1',
                                  -(apv["FRAME22"]["D"] - apv["FRAME19"]["AH"] - apv["FRAME52"]["A"]), 'ZX plane', 1,
                                  217)
        mprog.add_offset_assembly('FRAME53.1', 'FRAME11.1',
        ...
        mprog.add_offset_assembly(S_i.COVER_list[stamping_press_type]+'.1', 'FRAME1.1', (apv['FRAME1']['A'])+zeta, 'XY plane', 1, 242)
        ...
        if travel_type == 1:
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', 'FRAME20.1', -S_assmebly_par['MB_XY'], 'XY plane', 0, 323)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', 'FRAME20.1', S_assmebly_par['MB_YZ'], 'YZ plane', 0, 324)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', 'FRAME20.1', -S_assmebly_par['MB_ZX'], 'ZX plane', 1, 325)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', -S_assmebly_par['M_XY'], 'XY plane', 0, 326)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', -S_assmebly_par['M_YZ'], 'YZ plane', 0, 327)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_S_list[stamping_press_type]+'.1', -S_assmebly_par['M_ZX'], 'ZX plane', 1, 328)
        else:
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', 'FRAME20.1', -S_assmebly_par['MB_XY'], 'XY plane', 0, 323)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', 'FRAME20.1', S_assmebly_par['MB_YZ'], 'YZ plane', 0, 324)
            mprog.add_offset_assembly(S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', 'FRAME20.1', -S_assmebly_par['MB_ZX'], 'ZX plane', 1, 325)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', -S_assmebly_par['M_XY'], 'XY plane', 0, 326)
            mprog.add_offset_assembly(S_i.MOTOR_list[stamping_press_type]+'.1', S_i.MOTOR_BRACKET_HP_list[stamping_press_type]+'.1', -S_assmebly_par['M_YZ'], 'YZ plane', 0, 327)
